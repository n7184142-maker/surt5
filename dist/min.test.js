...
try {
(e => {
e && mt.Pe.Re && gt.game[zt.A].layers[3].children.forEach(e => {
...
})(e), e && gt.game[zt.D][zt.Se].forEach(e => {
mt.Pe.Te && (e.sprite._tintRGB = 1), e.sprite.alpha = mt.Pe.Fe / 1e3;
}), (e => {
e && gt.game[zt.ce][zt.ye][zt.me].forEach(e => {
[ "tree", "table", "stairs", "bush" ].some(t => e.type.includes(t)) && (e.sprite.alpha = mt.Pe.Le / 100);
});
})(e);
} catch {}
}
...
At.set(a, n), Object.defineProperty(e, t, {
value: a,
writable: !0,
enumerable: !1,
configurable: !0
...
function n(e) {
return Object.keys(gt.game[zt.O].teamInfo).find(t => gt.game[zt.O].teamInfo[t].playerIds.includes(e.__id));
}

function a(e) {
const t = e[zt.ie][zt.Me];
...
function i(e) {
if (!Vt.De) return;
const {Ee: t, Ie: r, Be: n, Ye: a} = e, o = t ?? "idle", i = performance.now();
if (nr(i), "idle" === o) {
tr();
const e = $t(Vt.Ge), t = Vt.qe ?? $t(e);
if (!a && Ht(t, e)) {
const r = Qt(t, e);
Vt.Ke = {
startPos: $t(t),
...
} else Vt.Ke = null, er(null);
Vt.Ee = "idle", Vt.Ve = null;
} else {
tr();
const e = r ? {
x: r.x,
y: r.y
} : $t(Vt.Ge), t = Vt.qe ?? $t(Vt.Ge), n = Ht(e, Vt.Ve);
o !== Vt.Ee || n ? (Vt.Ke = {
startPos: $t(t),
targetPos: $t(e),
startTime: i,
duration: a ? 0 : Qt(t, e)
}, Vt.Ve = $t(e)) : Vt.Ke && (Vt.Ke.targetPos = $t(e)), Vt.Ee = o;
}
const s = Wt(n);
((e, t) => !((e || t) && (!e || !t || e.touchMoveActive !== t.touchMoveActive || Math.abs(e.touchMoveLen - t.touchMoveLen) > Ut || Math.abs(e.x - t.x) > Ut || Math.abs(e.y - t.y) > Ut)))(s, Vt.Ue) || (Vt.He = {
startDir: Wt(Vt.We),
targetDir: s,
startTime: i,
duration: Vt.Ke?.duration ?? 195
}, Vt.Ue = s), nr(i);
}

function s(e) {
const t = gt.game[zt.$], r = n(e) === n(t), a = mt.$e.je && mt.$e.Xe;
...
function l() {
try {
const e = gt.game[zt.$], t = gt.game[zt.O].playerPool[zt.me];
if (!(gt.pixi && e && e.container && gt.game?.initialized)) return;
const r = Mr(e.container, "playerLines");
r.clear(), mt.$e.je && mt.$e.Ze && ((e, t, r) => {
const a = e[zt.de].x, o = e[zt.de].y, i = n(e), s = wr(e.layer), l = vr(e);
t.forEach(t => {
if (!t.active || t[zt.ie][zt.ze] || e.__id === t.__id) return;
const c = n(t), d = kr(t.layer, l, s);
let u;
u = c === i ? br : !d || t.downed ? dr : ur;
const b = 16 * (t[zt.de].x - a), f = 16 * (o - t[zt.de].y);
r.lineStyle(3.5, u, .2), r.moveTo(0, 0), r.lineTo(b, f), r.lineStyle(2.2, u, .7), 
r.moveTo(0, 0), r.lineTo(b, f);
});
})(e, t, r);
const i = Mr(e.container, "grenadeDangerZones");
i.clear(), mt.$e.je && mt.$e.Qe.Je && ((e, t) => {
const r = e[zt.de].x, n = e[zt.de].y, a = wr(e.layer), o = vr(e), i = gt.game?.[zt.U]?.[zt.Ae];
i && Object.values(i).filter(e => 9 === e.__type && "smoke" !== e.type || e.smokeEmitter && e.explodeParticle).forEach(e => {
const i = kr(e.layer, o, a), s = i ? .15 : .08, l = i ? fr : dr, c = 16 * (e.pos.x - r), d = 16 * (n - e.pos.y);
...
const l = Mr(e.container, "grenadeTrajectory");
l.clear(), mt.$e.je && mt.$e.Qe.et && ((e, t) => {
if (3 !== e[zt.se][zt.ke]) return;
const r = e[zt.ie][zt.Me];
if (!r) return;
const n = gt.game, a = e[zt.de].x, o = e[zt.de].y;
let i, s;
const l = n[zt.G].spectating, c = n[zt.M].shotDetected || n[zt.re].isBindDown(Tt), d = l ? null : or();
if (d) {
const e = n[zt.S][zt.we]({
x: a,
y: o
}), t = d.x - e.x, r = d.y - e.y, l = Math.sqrt(t * t + r * r);
i = t / l, s = r / l;
} else if (l || pt.tt && c) if (!l && pt.tt) {
const e = n[zt.S][zt.we]({
x: a,
y: o
}), t = pt.tt.clientX - e.x, r = pt.tt.clientY - e.y, l = Math.sqrt(t * t + r * r);
i = t / l, s = r / l;
} else i = e[zt.pe].x, s = e[zt.pe].y; else {
const e = n[zt.te].mousePos._x - ct.innerWidth / 2, t = n[zt.te].mousePos._y - ct.innerHeight / 2, r = Math.sqrt(e * e + t * t);
i = e / r, s = t / r;
}
const u = .03489949670250097 * i + .9993908270190958 * s;
i = .9993908270190958 * i - .03489949670250097 * s, s = u;
const b = Math.min(Math.max(ht.rt, 0), 32.4) / 15 * (r.includes("smoke") ? 11 : 15), f = a + i * b, p = o - s * b;
let h = pr;
r.includes("smoke") ? h = hr : r.includes("frag") ? h = gr : r.includes("mirv") ? h = mr : r.includes("martyr") && (h = xr);
const g = 16 * (f - a), m = 16 * (o - p);
t.lineStyle(5, h, .2), t.moveTo(0, 0), t.lineTo(g, m), t.lineStyle(3, h, .8), t.moveTo(0, 0), 
t.lineTo(g, m);
const x = r.replace("_cook", ""), y = Lt[x]?.explosionType;
if (y && Lt[y]) {
const e = 16 * (Lt[y].rad.max + 1);
...
const c = Mr(e.container, "flashlights");
c.clear(), mt.$e.je && (mt.$e.nt.p || mt.$e.nt.ot) && ((e, t, r) => {
const i = a(e), s = o(i), l = wr(e.layer), c = vr(e);
mt.$e.nt.ot && _r(e, e, s, i, r), mt.$e.nt.p && t.filter(t => !(!t.active || t[zt.ie][zt.ze] || e.__id === t.__id || !kr(t.layer, c, l) || !t.container.worldVisible || n(t) === n(e))).forEach(t => {
const n = a(t), i = o(n);
_r(e, t, i, n, r, 0, .05);
});
})(e, t, c);
const d = Mr(e.container, "bulletTrajectory");
d.clear(), mt.$e.je && mt.$e.nt.et && ((e, t) => {
const r = a(e), n = o(r);
if (!n || !r) return;
const i = gt.game, s = e[zt.de], l = i[zt.G].spectating, c = i[zt.M].shotDetected || i[zt.re].isBindDown(Tt);
let d;
const u = l ? null : or();
if (u) {
const e = i[zt.S][zt.we]({
x: s.x,
y: s.y
});
...
d = Math.atan2(e.y - pt.tt.clientY, e.x - pt.tt.clientX) - Math.PI;
} else d = Math.atan2(e[zt.pe].x, e[zt.pe].y) - Math.PI / 2; else d = Math.atan2(i[zt.te].mousePos._y - ct.innerHeight / 2, i[zt.te].mousePos._x - ct.innerWidth / 2);
const b = It.it(Math.cos(d), -Math.sin(d)), f = cr(s, b, r), p = i?.[zt.U]?.[zt.Ae], h = isLayerSpoofActive && void 0 !== originalLayerValue ? originalLayerValue : e.layer;
let g = null;
if (p) {
...
const e = Yt.st(r.collider, s, f);
if (e) {
const r = It.lt(It.ct(e.point, s));
t > r && (t = r, g = It.dt(e.point, It.ut(e.normal, .01)));
}
}
}
const m = ((e, t, r, n, a, o = 3) => {
const i = [];
let s = It.bt(e), l = It.ft(t), c = r, d = 0;
const u = gt.game, b = u?.[zt.U]?.[zt.Ae];
if (!b) return i;
const f = isLayerSpoofActive && void 0 !== originalLayerValue ? originalLayerValue : n, p = Object.values(b).filter(e => !(!e.collider || e.dead || void 0 !== e.height && .25 > e.height || void 0 !== e.layer && !Gt(e.layer, f) || e?.type.includes("decal") || e?.type.includes("decal"))), h = u?.[zt.O], g = h?.playerPool?.[zt.me], m = zt.ee, x = m ? u?.[m] : null, y = x?.player?.radius ?? 1, w = [];
...
for (;o >= d && c > .1; ) {
const e = It.dt(s, It.ut(l, c));
let t = null, r = 1 / 0, n = null, a = null;
for (const o of p) {
if (!1 === o.collidable) continue;
const i = Yt.st(o.collider, s, e);
if (i) {
const e = It.lt(It.ct(i.point, s));
r > e && e > 1e-4 && (r = e, t = i, n = o, a = "obstacle");
}
}
for (const o of w) {
const i = Yt.ht(s, e, o.pos, o.rad);
if (i) {
const e = It.lt(It.ct(i.point, s));
...
!u || d >= o) break;
{
const e = It.gt(l, t.normal);
l = It.dt(It.ut(t.normal, -2 * e), l), l = It.ft(l), s = It.dt(t.point, It.ut(l, .01)), 
c = Math.max(1, c - Math.sqrt(r)) / 1.5, d++;
}
}
}
return i;
})(g || f, b, n.distance, e.layer, e), x = m.some(e => e.hitPlayer), y = x ? fr : 16711935, w = x ? 3 : 2;
t.lineStyle(w + 2, y, .2);
for (const e of m) {
const r = {
x: 16 * (e.start.x - s.x),
...
try {
const e = gt.game;
if (!e.initialized || !mt.xt.je && !mt.yt.je || e[zt.G].spectating) return i(new Kt("idle")), 
void (Rr.wt = null);
const t = e[zt.O].playerPool[zt.me], r = e[zt.$];
let s = !1, l = null, d = null, u = !1;
try {
const b = e[zt.$][zt.se][zt.ke], f = 2 === b, p = 3 === b, h = e[zt.re].isBindDown(Tt), g = p && h, m = h || mt.xt.vt && Rr.kt && Rr.kt.active && !Rr.kt[zt.ie][zt.ze], x = mt.yt.je && (mt.xt.vt || h);
let y = Rr._t;
if (x) {
let e = !1;
if (y && (e = void 0 !== y.active ? y.active && !y[zt.ie]?.[zt.ze] : !y.dead), !e) {
if (y = ((e, t) => {
const r = n(t), a = Pr(t);
let o = null, i = 1 / 0;
for (const s of e) {
if (!s.active) continue;
if (s[zt.ie][zt.ze]) continue;
if (!mt.xt.Mt && s.downed) continue;
if (t.__id === s.__id) continue;
if (!Fr(s.layer, a)) continue;
if (n(s) === r && !mt.yt.zt && !mt.xt.St) continue;
const e = t[zt.be], l = s[zt.be], c = Yr(e.x, e.y, l.x, l.y);
i > c && (i = c, o = s);
}
return o;
})(t, r), !y) {
const e = (e => {
if (!mt.yt.je) return null;
const t = gt.game, r = t?.[zt.U]?.[zt.Ae];
if (!r) return null;
const n = e[zt.be], a = Pr(e);
let o = null, i = 1 / 0;
for (const e of Object.values(r)) {
if (!c(e)) continue;
if (void 0 !== e.layer && !Fr(e.layer, a)) continue;
const t = e[zt.be];
if (!t) continue;
...
} else y = null, Rr._t = null;
let w = 1 / 0, v = null, k = !1;
if (y) {
const e = r[zt.be], t = y[zt.be];
if (w = Math.hypot(e.x - t.x, e.y - t.y), k = void 0 === y.active, !k) {
const e = y.__id;
if (Rr.Ct[e]?.At) {
const r = Rr.Ct[e].At, n = Math.max(.05, w / 150);
v = {
x: t.x + r.x * n,
y: t.y + r.y * n
};
...
const M = 6.5 >= w, z = 7.5 >= w, _ = mt.xt.Nt && mt.yt.Ot && 11.25 >= w;
x && mt.yt.Ot && !f && (M || _) && y && (ht.jt.push(Et), Rr.Pt = !0), (f || !M && !_) && (Rr.Pt = !1);
const N = x && (M || _) && y && (f || Rr.Pt);
if (N) {
const t = r[zt.be], n = v || y[zt.be], l = a(r), c = o(l);
let d = k;
if (d || (d = !mt.xt.Rt || Dr(r, y, l, c)), d) {
const r = ((e, t) => It.Tt(e, t))(n, t) + Math.PI, a = {
touchMoveActive: !0,
touchMoveLen: 255,
x: Math.cos(r),
y: Math.sin(r)
...
return mt.yt.Ft && f && 5.5 > w && ht.jt.push(Tt), i(new Kt("meleeLock", {
x: o.x,
y: o.y
}, a, !0)), s = !0, lr(), void (Rr.wt = null);
}
}
if (x && !z && (Rr._t = null), !mt.xt.je || f || N || p && !g) return i(new Kt("idle")), 
lr(), void (Rr.wt = null);
const j = m;
let A = Rr.Lt?.active && !Rr.Lt[zt.ie][zt.ze] ? Rr.Lt : null;
if (A) {
const e = Pr(r);
Fr(A.layer, e) || (A = null, Rr.Lt = null, i(new Kt("idle", null, null, !0)));
}
if (A || (Rr.Lt && (Rr.Lt = null, i(new Kt("idle", null, null, !0))), A = ((e, t) => {
const r = n(t), i = Pr(t);
let s = null, l = -1 / 0;
const c = mt.xt.Dt ** 2;
performance.now();
...
if (d[zt.ie][zt.ze]) continue;
if (!mt.xt.Mt && d.downed) continue;
if (t.__id === d.__id) continue;
if (!Fr(d.layer, i)) continue;
if (n(d) === r && !mt.xt.St) continue;
const e = gt.game[zt.S][zt.we]({
x: d[zt.be].x,
y: d[zt.be].y
}), u = Yr(e.x, e.y, gt.game[zt.te].mousePos._x, gt.game[zt.te].mousePos._y);
if (u > c) continue;
const b = Math.exp(-Math.sqrt(u) / 120), f = d === Rr.kt ? .02 : 0, p = a(t), h = o(p), g = b + f + (!mt.xt.Rt || Dr(t, d, p, h) ? .03 : 0);
g > l && (l = g, s = d);
}
return s;
})(t, r), Rr.kt = A), A) {
const e = r[zt.be], t = A[zt.be], n = Math.hypot(e.x - t.x, e.y - t.y);
A === Rr.kt || Rr.Lt || (Rr.kt = A, Rr.Ct[A.__id] = [], Rr.Et[A.__id] = []);
const c = ((e, t) => {
if (!e || !t) return null;
const r = e[zt.be], n = t[zt.be], i = e.__id, s = Rr.Ct[i] ?? (Rr.Ct[i] = []), l = performance.now();
if (s.push([ l, {
...r
} ]), s.length > 20 && s.shift(), 3 > s.length) return gt.game[zt.S][zt.we]({
x: r.x,
y: r.y
});
let c = 0, d = 0;
const u = Math.max(0, s.length - 3), b = s.length - 1, f = s[u][1], p = s[b][1], h = (s[b][0] - s[u][0]) / 1e3;
...
const m = o(a(t)), x = Bt.It(n, r, {
x: c,
y: d
}, m?.speed || 1e3);
if (null === x) return gt.game[zt.S][zt.we](r);
const y = mt.xt.Bt ?? 1;
return gt.game[zt.S][zt.we]({
x: r.x + c * x * y,
y: r.y + d * x * y
});
})(A, r);
if (!c) return i(new Kt("idle")), lr(), void (Rr.wt = null);
d = {
x: c.x,
y: c.y
};
const b = a(r), f = o(b), p = f?.distance || 1 / 0, h = p >= n && (mt.xt.Nt || !mt.xt.Rt || Dr(r, A, b, f)), g = p >= n && (!mt.xt.Rt || Dr(r, A, b, f));
if (Rr.Yt = g, j && (mt.xt.je || mt.yt.je && 8 >= n)) if (h) {
i(new Kt("aimbot", {
x: c.x,
y: c.y
}, null, !0)), Rr.wt = {
...
const e = (e => {
if (!mt.xt.je) return null;
const t = gt.game, r = t?.[zt.U]?.[zt.Ae];
if (!r) return null;
const n = e[zt.be], a = Pr(e), o = mt.xt.Dt ** 2;
let i = null, s = -1 / 0;
for (const e of Object.values(r)) {
if (!c(e)) continue;
if (void 0 !== e.layer && !Fr(e.layer, a)) continue;
const t = e[zt.be];
if (!t) continue;
const r = gt.game[zt.S][zt.we]({
x: t.x,
y: t.y
}), l = Yr(r.x, r.y, gt.game[zt.te].mousePos._x, gt.game[zt.te].mousePos._y);
if (l > o) continue;
const d = (100 > Yr(n.x, n.y, t.x, t.y) ? 50 : 0) - Math.sqrt(l);
d > s && (s = d, i = e);
}
return i;
})(r);
if (e) {
Rr.Gt = e;
const t = e[zt.be], n = gt.game[zt.S][zt.we]({
x: t.x,
y: t.y
}), c = Math.hypot(t.x - mePos.x, t.y - mePos.y);
if (j && mt.xt.je) {
const t = a(r), b = o(t), f = b?.distance || 1 / 0, p = f >= c && (mt.xt.Nt || !mt.xt.Rt || Dr(r, e, t, b)), h = f >= c && (!mt.xt.Rt || Dr(r, e, t, b));
if (p) {
i(new Kt("aimbot", {
x: n.x,
y: n.y
...
lr(), i(new Kt("idle", null, null, !0)), Rr._t = null, Rr.Lt = null, Rr.kt = null, 
Rr.wt = null;
}
} catch (e) {
i(new Kt({
...
function u() {
return Rr.kt && Rr.kt.active && !Rr.kt[zt.ie][zt.ze];
}

function b() {
gt.game?.initialized && (() => {
const e = gt.game, t = e[zt.$];
if (!t?.bodyContainer || e[zt.G].spectating) return;
const r = e[zt.te].mousePos.x - ct.innerWidth / 2, n = e[zt.te].mousePos.y - ct.innerHeight / 2;
t.bodyContainer.rotation = cn && pt.tt && (mt.xt.je || mt.yt.je) ? Math.atan2(pt.tt.clientY - ct.innerHeight / 2, pt.tt.clientX - ct.innerWidth / 2) || 0 : Math.atan2(n, r) || 0;
})();
}

function p(e) {
if ("cook" === gt.game[zt.$].throwableState) return "x" === e ? gt.game[zt.te].mousePos._x : gt.game[zt.te].mousePos._y;
const {centerX: t, centerY: r, radius: n} = (() => {
const e = ct.innerWidth / 2, t = ct.innerHeight / 2;
return {
centerX: e,
centerY: t,
radius: Math.hypot(gt.game[zt.te].mousePos._x - e, gt.game[zt.te].mousePos._y - t)
};
})();
let a;
return a = mt.Kt.qt ? on : mt.Kt.Vt || mt.Kt.Ut || mt.Kt.Ht ? mt.Kt.Vt ? fn[dn] : mt.Kt.Ut ? bn[dn] : mt.Kt.Ht ? un[dn] : ln : ln, 
...
if (arguments.length > 2 && (i.children = arguments.length > 3 ? fe.call(arguments, 2) : r), 
"function" == typeof e && null != e.Wt) for (o in e.Wt) void 0 === i[o] && (i[o] = e.Wt[o]);
...
return null == a && null != pe.ar && pe.ar(o), o;
}
...
function v(e, t) {
if (null == t) return e.Zt ? v(e.Zt, e.rr + 1) : null;
for (var r; e.Xt.length > t; t++) if (null != (r = e.Xt[t]) && null != r.Qt) return r.Qt;
return "function" == typeof e.type ? v(e) : null;
}

function k(e) {
var t, r;
if (null != (e = e.Zt) && null != e.er) {
for (e.Qt = e.er.base = null, t = 0; e.Xt.length > t; t++) if (null != (r = e.Xt[t]) && null != r.Qt) {
e.Qt = e.er.base = r.Qt;
break;
}
return k(e);
...
function M(e) {
(!e.ir && (e.ir = !0) && ge.push(e) && !z.sr++ || me != pe.lr) && ((me = pe.lr) || xe)(z);
}

function z() {
for (var e, t, r, n, a, o, i, s = 1; ge.length; ) ge.length > s && ge.sort(ye), 
e = ge.shift(), s = ge.length, e.ir && (r = void 0, n = void 0, a = (n = (t = e).tr).Qt, 
o = [], i = [], t.cr && ((r = h({}, n)).tr = n.tr + 1, pe.ar && pe.ar(r), R(t.cr, r, n, t.dr, t.cr.namespaceURI, 32 & n.nr ? [ a ] : null, o, a ?? v(n), !!(32 & n.nr), i), 
r.tr = n.tr, r.Zt.Xt[r.rr] = r, F(o, r, i), n.Qt = n.Zt = null, r.Qt != a && k(r)));
z.sr = 0;
}

function _(e, t, r, n, a, o, i, s, l, c, d) {
var u, b, f, p, h, g, m, w = n && n.Xt || _e, k = t.length;
for (l = ((e, t, r, n, a) => {
var o, i, s, l, c, d = r.length, u = d, b = 0;
for (e.Xt = Array(a), o = 0; a > o; o++) null != (i = t[o]) && "boolean" != typeof i && "function" != typeof i ? ("string" == typeof i || "number" == typeof i || "bigint" == typeof i || i.constructor == String ? i = e.Xt[o] = x(null, i, null, null, null) : je(i) ? i = e.Xt[o] = x(y, {
children: i
}, null, null, null) : null == i.constructor && i.Jt > 0 ? i = e.Xt[o] = x(i.type, i.$t, i.key, i.ref ? i.ref : null, i.tr) : e.Xt[o] = i, 
l = o + b, i.Zt = e, i.Jt = e.Jt + 1, -1 != (c = i.rr = A(i, r, l, u)) && (u--, 
(s = r[c]) && (s.nr |= 2)), null == s || null == s.tr ? (-1 == c && (a > d ? b-- : d > a && b++), 
"function" != typeof i.type && (i.nr |= 4)) : c != l && (c == l - 1 ? b-- : c == l + 1 ? b++ : (c > l ? b-- : b++, 
i.nr |= 4))) : e.Xt[o] = null;
if (u) for (o = 0; d > o; o++) null != (s = r[o]) && !(2 & s.nr) && (s.Qt == n && (n = v(s)), 
D(s, s));
return n;
})(r, t, w, l, k), u = 0; k > u; u++) null != (f = r.Xt[u]) && (b = -1 == f.rr ? ze : w[f.rr] || ze, 
f.rr = u, g = R(e, f, b, a, o, i, s, l, c, d), p = f.Qt, f.ref && b.ref != f.ref && (b.ref && L(b.ref, null, f), 
d.push(f.ref, f.er || p, f)), null == h && null != p && (h = p), (m = !!(4 & f.nr)) || b.Xt === f.Xt ? l = N(f, l, e, m) : "function" == typeof f.type && void 0 !== g ? l = g : p && (l = p.nextSibling), 
f.nr &= -7);
return r.Qt = h, l;
}
...
for (a = e.Xt, o = 0; a && a.length > o; o++) a[o] && (a[o].Zt = e, t = N(a[o], t, r, n));
return t;
}
e.Qt != t && (n && (t && e.type && !t.parentNode && (t = v(e)), r.insertBefore(e.Qt, t || null)), 
t = e.Qt);
do {
t = t && t.nextSibling;
...
function j(e, t) {
return t = t || [], null == e || "boolean" == typeof e || (je(e) ? e.some(e => {
j(e, t);
}) : t.push(e)), t;
}

function A(e, t, r, n) {
var a, o, i, s = e.key, l = e.type, c = t[r], d = null != c && !(2 & c.nr);
if (null === c && null == s || d && s == c.key && l == c.type) return r;
if (n > (d ? 1 : 0)) for (a = r - 1, o = r + 1; a >= 0 || t.length > o; ) if (null != (c = t[i = 0 > a ? o++ : a--]) && !(2 & c.nr) && s == c.key && l == c.type) return i;
return -1;
}

function S(e, t, r) {
"-" == t[0] ? e.setProperty(t, r ?? "") : e[t] = null == r ? "" : "number" != typeof r || Ne.test(t) ? r : r + "px";
}
...
} else if ("o" == t[0] && "n" == t[1]) o = t != (t = t.replace(we, "$1")), i = t.toLowerCase(), 
t = i in e || "onFocusOut" == t || "onFocusIn" == t ? i.slice(2) : t.slice(2), e.l || (e.l = {}), 
e.l[t + o] = r, r ? n ? r.u = n.u : (r.u = ve, e.addEventListener(t, o ? Me : ke, o)) : e.removeEventListener(t, o ? Me : ke, o); else {
...
if (null == t.t) t.t = ve++; else if (r.u > t.t) return;
return r(pe.event ? pe.event(t) : t);
}
};
}

function R(e, t, r, n, a, o, i, s, l, c) {
var d, u, b, f, p, m, x, v, k, M, z, N, j, A, S, O, C, R = t.type;
if (null != t.constructor) return null;
128 & r.nr && (l = !!(32 & r.nr), o = [ s = t.Qt = r.Qt ]), (d = pe.Jt) && d(t);
e: if ("function" == typeof R) try {
if (v = t.$t, k = "prototype" in R && R.prototype.render, M = (d = R.contextType) && n[d.er], 
z = d ? M ? M.$t.value : d.Zt : n, r.er ? x = (u = t.er = r.er).Zt = u.ur : (k ? t.er = u = new R(v, z) : (t.er = u = new w(v, z), 
u.constructor = R, u.render = I), M && M.sub(u), u.state || (u.state = {}), u.dr = n, 
b = u.ir = !0, u.br = [], u._sb = []), k && null == u.pr && (u.pr = u.state), k && null != R.hr && (u.pr == u.state && (u.pr = h({}, u.pr)), 
h(u.pr, R.hr(v, u.pr))), f = u.$t, p = u.state, u.tr = t, b) k && null == R.hr && null != u.gr && u.gr(), 
k && null != u.mr && u.br.push(u.mr); else {
if (k && null == R.hr && v !== f && null != u.yr && u.yr(v, z), t.tr == r.tr || !u.Qt && null != u.wr && !1 === u.wr(v, u.pr, z)) {
for (t.tr != r.tr && (u.$t = v, u.state = u.pr, u.ir = !1), t.Qt = r.Qt, t.Xt = r.Xt, 
t.Xt.some(e => {
e && (e.Zt = t);
}), N = 0; u._sb.length > N; N++) u.br.push(u._sb[N]);
u._sb = [], u.br.length && i.push(u);
break e;
}
null != u.vr && u.vr(v, u.pr, z), k && null != u.kr && u.br.push(() => {
u.kr(f, p, m);
});
}
if (u.context = z, u.$t = v, u.cr = e, u.Qt = !1, j = pe.sr, A = 0, k) {
for (u.state = u.pr, u.ir = !1, j && j(t), d = u.render(u.$t, u.state, u.context), 
S = 0; u._sb.length > S; S++) u.br.push(u._sb[S]);
u._sb = [];
} else do {
u.ir = !1, j && j(t), d = u.render(u.$t, u.state, u.context), u.state = u.pr;
} while (u.ir && 25 > ++A);
u.state = u.pr, null != u._r && (n = h(h({}, n), u._r())), k && !b && null != u.Mr && (m = u.Mr(f, p)), 
O = d, null != d && d.type === y && null == d.key && (O = T(d.$t.children)), s = _(e, je(O) ? O : [ O ], t, r, n, a, o, i, s, l, c), 
u.base = t.Qt, t.nr &= -161, u.br.length && i.push(u), x && (u.ur = u.Zt = null);
} catch (e) {
if (t.tr = null, l || null != o) if (e.then) {
for (t.nr |= l ? 160 : 128; s && 8 == s.nodeType && s.nextSibling; ) s = s.nextSibling;
o[o.indexOf(s)] = null, t.Qt = s;
} else {
for (C = o.length; C--; ) g(o[C]);
P(t);
} else t.Qt = r.Qt, t.Xt = r.Xt, e.then || P(t);
pe.Qt(e, t, r);
} else null == o && t.tr == r.tr ? (t.Xt = r.Xt, t.Qt = r.Qt) : s = t.Qt = E(r.Qt, t, r, n, a, o, i, l, c);
return (d = pe.zr) && d(t), 128 & t.nr ? void 0 : s;
}

function P(e) {
e && e.er && (e.er.Qt = !0), e && e.Xt && e.Xt.forEach(P);
}

function F(e, t, r) {
for (var n = 0; r.length > n; n++) L(r[n], r[++n], r[++n]);
pe.er && pe.er(t, e), e.some(t => {
try {
e = t.br, t.br = [], e.some(e => {
e.call(t);
});
} catch (e) {
pe.Qt(e, t.tr);
...
function T(e) {
return "object" != typeof e || null == e || e.Jt && e.Jt > 0 ? e : je(e) ? e.map(T) : h({}, e);
}

function E(e, t, r, n, a, o, i, s, l) {
var c, d, u, b, f, p, h, m = r.$t || ze, x = t.$t, y = t.type;
...
e = document.createElementNS(a, y, x.is && x), s && (pe.Sr && pe.Sr(t, o), s = !1), 
o = null;
}
if (null == y) m === x || s && e.data == x || (e.data = x); else {
if (o = o && fe.call(e.childNodes), !s && null != o) for (m = {}, c = 0; e.attributes.length > c; c++) m[(f = e.attributes[c]).name] = f.value;
for (c in m) if (f = m[c], "children" == c) ; else if ("dangerouslySetInnerHTML" == c) u = f; else if (!(c in x)) {
if ("value" == c && "defaultValue" in x || "checked" == c && "defaultChecked" in x) continue;
O(e, c, null, f, a);
}
for (c in x) f = x[c], "children" == c ? b = f : "dangerouslySetInnerHTML" == c ? d = f : "value" == c ? p = f : "checked" == c ? h = f : s && "function" != typeof f || m[c] === f || O(e, c, f, m[c], a);
if (d) s || u && (d.Ar == u.Ar || d.Ar == e.innerHTML) || (e.innerHTML = d.Ar), 
t.Xt = []; else if (u && (e.innerHTML = ""), _("template" == t.type ? e.content : e, je(b) ? b : [ b ], t, r, n, "foreignObject" == y ? "http://www.w3.org/1999/xhtml" : a, o, i, o ? o[0] : r.Xt && v(r, 0), s, l), 
null != o) for (c = o.length; c--; ) g(o[c]);
s || (c = "value", "progress" == y && null == p ? e.removeAttribute("value") : null != p && (p !== e[c] || "progress" == y && !p || "option" == y && p != m[c]) && O(e, c, p, m[c], a), 
c = "checked", null != h && h != e[c] && O(e, c, h, m[c], a));
}
return e;
}
...
function D(e, t, r) {
var n, a;
if (pe.unmount && pe.unmount(e), (n = e.ref) && (n.current && n.current != e.Qt || L(n, null, t)), 
null != (n = e.er)) {
if (n.Cr) try {
n.Cr();
} catch (e) {
...
if (n = e.Xt) for (a = 0; n.length > a; a++) n[a] && D(n[a], t, r || "function" != typeof e.type);
r || g(e.Qt), e.er = e.Zt = e.Qt = void 0;
}
...
function Y(e, t, r) {
var n, a, o, i;
t == document && (t = document.documentElement), pe.Zt && pe.Zt(e, t), a = (n = "function" == typeof r) ? null : r && r.Xt || t.Xt, 
o = [], i = [], R(t, e = (!n && r || t).Xt = m(y, null, [ e ]), a || ze, ze, t.namespaceURI, !n && r ? [ r ] : a ? null : t.firstChild ? fe.call(t.childNodes) : null, o, !n && r ? r : a ? a.Qt : t.firstChild, n, i), 
F(o, e, i);
}
...
function B(e, t) {
Fe.br && Fe.br(Se, e, Re || t), Re = 0;
var r = Se.Nr || (Se.Nr = {
Zt: [],
br: []
});
return e >= r.Zt.length && r.Zt.push({}), r.Zt[e];
}

function K(e) {
return Re = 1, function(e, t) {
var r, n, a, o = B(Ae++, 2);
return o.t = e, o.er || (o.Zt = [ Q(void 0, t), e => {
var t = o.Or ? o.Or[0] : o.Zt[0], r = o.t(t, e);
t !== r && (o.Or = [ r, o.Zt[1] ], o.er.jr({}));
} ], o.er = Se, Se.Pr) || (r = function(e, t, r) {
var a, i;
return !o.er.Nr || (a = o.er.Nr.Zt.filter(e => !!e.er), a.every(e => !e.Or) ? !n || n.call(this, e, t, r) : (i = o.er.$t !== e, 
a.forEach(e => {
if (e.Or) {
var t = e.Zt[0];
e.Zt = e.Or, e.Or = void 0, t !== e.Zt[0] && (i = !0);
}
}), n && n.call(this, e, t, r) || i));
}, Se.Pr = !0, n = Se.wr, a = Se.vr, Se.vr = function(e, t, o) {
if (this.Qt) {
var i = n;
...
function U(e, t) {
var r = B(Ae++, 3);
!Fe.pr && J(r.Nr, t) && (r.Zt = e, r.u = t, Se.Nr.br.push(r));
}
...
function V(e, t) {
var r = B(Ae++, 7);
return J(r.Nr, t) && (r.Zt = e(), r.Nr = t, r.br = e), r.Zt;
}
...
function H() {
for (var e; e = Pe.shift(); ) if (e.cr && e.Nr) try {
e.Nr.br.forEach(X), e.Nr.br.forEach(Z), e.Nr.br = [];
} catch (t) {
e.Nr.br = [], Fe.Qt(t, e.tr);
}
}
...
function X(e) {
var t = Se, r = e.er;
"function" == typeof r && (e.er = void 0, r()), Se = t;
}
...
function re(e, t, r) {
return e && (e.er && e.er.Nr && (e.er.Nr.Zt.forEach(e => {
"function" == typeof e.er && e.er();
}), e.er.Nr = null), null != (e = ((e, t) => {
for (var r in t) e[r] = t[r];
return e;
})({}, e)).er && (e.er.cr === r && (e.er.cr = t), e.er.Qt = !0, e.er = null), e.Xt = e.Xt && e.Xt.map(e => re(e, t, r))), 
e;
}

function ne(e, t, r) {
return e && r && (e.tr = null, e.Xt = e.Xt && e.Xt.map(e => ne(e, t, r)), e.er && e.er.cr === t && (e.Qt && r.appendChild(e.Qt), 
e.er.Qt = !0, e.er.cr = r)), e;
}

function ae() {
this.nr = 0, this.o = null, this.Jt = null;
}

function oe(e) {
var t = e.Zt.er;
return t && t.Rr && t.Rr(e);
}
...
Tr: a,
Fr: o
}, "function" == typeof e && (i = e.Wt)) for (s in i) void 0 === l[s] && (l[s] = i[s]);
return pe.ar && pe.ar(c), c;
}
...
var fe, pe, he, ge, me, xe, ye, we, ve, ke, Me, ze, _e, Ne, je, Ae, Se, Oe, Ce, Re, Pe, Fe, Te, Ee, Le, De, Ie, Ye, Ge, Be, Ke, Ue, qe, Ve, $e, He, We, Xe, Ze, Je, Qe, et, tt, rt, nt, at, ot, it;

const st = "".charCodeAt, lt = String.fromCharCode, ct = window.ou, dt = window.ou.document, ut = window.sr, bt = window.pr, ft = "__cf_ray", pt = {
tt: null,
Lr: null
}, ht = {
jt: [],
...
if ("_k" === i) continue;
const s = e[i], l = t?.[i];
if ("object" == typeof s && s._k) o[i] = a(s, l, n + "." + i); else {
const e = n + "." + i;
r[e] = "number" == typeof l || "string" == typeof l ? l : !!l, Object.defineProperty(o, i, {
get() {
return r[e];
},
set(t) {
...
dt.cookie = (e => `${ft}=${e}; path=/; max-age=259200`)(t);
})(e(r)), yt = r), vt = !1;
})();
}, 250));
...
for (const e of Object.getOwnPropertyNames(Object)) Nt[e] = Object[e];

const jt = {};

for (const e of Object.getOwnPropertyNames(Reflect)) jt[e] = Reflect[e];

const At = new WeakMap;

r(ct.Function.prototype, "toString", {
apply(e, t, r) {
return Reflect.apply(e, At.get(t) || t, r);
}
}), r(ct.Element.prototype, "attachShadow", {
apply(e, t, r) {
...
const St = EventTarget.prototype.addEventListener, Ot = EventTarget.prototype.removeEventListener, Ct = Array.from({
length: 12
}, () => "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"[Math.floor(52 * Math.random())]).join(""), Rt = dt.fonts, Pt = e => {
try {
return e && "object" == typeof e && e.family === Ct;
} catch {
return !1;
}
}, Ft = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(Rt), "size");

Ft && Ft.get && (Ft.get = new Proxy(Ft.get, {
apply(e, t, r) {
try {
...
}), Object.defineProperty(Object.getPrototypeOf(Rt), "size", Ft)), r(Rt, "values", {
apply(e, t, r) {
const n = Reflect.apply(e, t, r);
return {
[Symbol.iterator]() {
...
next() {
let e = n.next();
for (;!e.done && Pt(e.value); ) e = n.next();
return e;
}
};
}
...
next() {
let e = n.next();
for (;!e.done && Pt(e.value[0]); ) e = n.next();
return e;
}
};
}
...
apply(e, t, r) {
const [n] = r;
return !Pt(n) && Reflect.apply(e, t, r);
}
}), r(Rt, "delete", {
apply(e, t, r) {
const [n] = r;
...
apply(e, t, r) {
const [n] = r;
return (!n || !n.includes(Ct)) && Reflect.apply(e, t, r);
}
}), r(Rt, Symbol.iterator, {
apply(e, t, r) {
const n = Reflect.apply(e, t, r);
return {
[Symbol.iterator]() {
...
r(ct.Object, "keys", {
apply(e, t, r) {
return "bullet" == r[0]?.bullet_mp5?.type && "explosion" == r[0]?.explosion_frag?.type && "gun" == r[0]?.mp5?.type && "throwable" == r[0]?.frag?.type && (Lt = r[0], 
ct.Object.keys = e), Reflect.apply(e, t, r);
}
});
...
tn: e => Math.sqrt(e.x * e.x + e.y * e.y),
...
hn: (e, t) => e.x * t.y - e.y * t.x,
gn: e => 1 - (1 - e) ** 3,
mn: e => .5 > e ? 2 * e * e : (4 - 2 * e) * e - 1,
xn: e => e * (2 - e),
yn: e => Math.max(0, Math.min(1, e)),
wn: (e, t, r) => Math.max(t, Math.min(r, e)),
pn: (e, t, r) => e + (t - e) * r,
Tt: (e, t) => Math.atan2(t.y - e.y, t.x - e.x),
vn(e, t) {
let r = e - t;
for (;r > Math.PI; ) r -= 2 * Math.PI;
for (;-Math.PI > r; ) r += 2 * Math.PI;
return r;
},
rn(e, t, r, n) {
const a = r - e, o = n - t;
...
kn: (e, t) => Math.hypot(e.x - t.x, e.y - t.y),
_n(e, t) {
const r = e.x - t.x, n = e.y - t.y;
return r * r + n * n;
},
...
Nn: e => (e = Math.max(0, Math.min(1, e))) * e * (3 - 2 * e),
On: e => (e = Math.max(0, Math.min(1, e))) * e * e * (e * (6 * e - 15) + 10),
jn(e) {
if (1e-10 > e) return 0;
let t = 1 / Math.sqrt(e);
...
Pn(e, t, r, n) {
const a = It.ct(t, e), o = Math.abs(a.x) > 1e-4 ? 1 / a.x : 1e10, i = Math.abs(a.y) > 1e-4 ? 1 / a.y : 1e10, s = (r.x - e.x) * o, l = (n.x - e.x) * o, c = (r.y - e.y) * i, d = (n.y - e.y) * i, u = Math.max(Math.min(s, l), Math.min(c, d)), b = Math.min(Math.max(s, l), Math.max(c, d));
if (0 > b || u > b || u > 1) return null;
const f = Math.max(0, Math.min(1, u)), p = It.dt(e, It.ut(a, f)), h = It.ut(It.dt(r, n), .5), g = It.ut(It.ct(n, r), .5), m = It.ct(p, h);
let x;
...
ht(e, t, r, n) {
const a = It.ct(t, e), o = It.ct(e, r), i = It.gt(a, a), s = 2 * It.gt(o, a);
let l = s * s - 4 * i * (It.gt(o, o) - n * n);
if (0 > l) return null;
l = Math.sqrt(l);
const c = (-s - l) / (2 * i), d = (-s + l) / (2 * i);
let u = -1;
if (0 > c || c > 1 ? 0 > d || d > 1 || (u = d) : u = c, 0 > u) return null;
const b = It.dt(e, It.ut(a, u));
return {
point: b,
normal: It.ft(It.ct(b, r)),
t: u
};
},
st: (e, t, r) => e ? 1 === e.type ? Yt.Pn(t, r, e.min, e.max) : 0 === e.type ? Yt.ht(t, r, e.pos, e.rad) : null : null,
Rn: (e, t, r) => It.nn(e, t) <= r * r,
Tn: (e, t, r) => !(t.x > e.x || e.x > r.x || t.y > e.y || e.y > r.y),
Fn(e, t, r) {
const n = It.ct(r, t), a = It.ct(e, t), o = It.lt(n);
if (0 === o) return t;
const i = It.yn(It.gt(a, n) / o);
return It.dt(t, It.ut(n, i));
}
}, Gt = (e, t) => (1 & e) == (1 & t) || 2 & e && 2 & t, Bt = {
It(e, t, r, n) {
const a = t.x - e.x, o = t.y - e.y, i = r.x * r.x + r.y * r.y - n * n, s = 2 * (a * r.x + o * r.y), l = s * s - 4 * i * (a * a + o * o);
if (0 > l) return null;
const c = Math.sqrt(l), d = (-s - c) / (2 * i), u = (-s + c) / (2 * i);
return d > 1e-4 ? d : u > 1e-4 ? u : null;
},
Ln(e, t, r, n, a, o, i = .2) {
const s = t.x - (r?.x ?? t.x), l = t.y - (r?.y ?? t.y), c = Bt.It(e, t, {
x: s,
y: l
}, a);
...
let o = .016;
for (let i = 0; a > i; i++) {
const a = Math.hypot(t.x + r.x * o - e.x, t.y + r.y * o - e.y) / n;
...
En(e, t, r, n, a) {
const o = Bt.Dn(a, e, t, n);
return {
x: e.x + t.x * o + .5 * r.x * o * o,
y: e.y + t.y * o + .5 * r.y * o * o
};
},
In: (e, t) => t ? {
x: e.x - t.x,
...
Yn(e, t, r = 3) {
const n = Math.hypot(e.x, e.y), a = Math.hypot(t.x, t.y);
return !(n > 2500 || a > .1 && Math.hypot(e.x - t.x, e.y - t.y) / (a + .1) > r);
},
Gn(e, t, r, n) {
const a = It.ct(t, e), o = Math.abs(It.cn(Math.atan2(a.y, a.x) - Math.atan2(r.y, r.x)));
return n * Math.PI / 180 >= o;
},
qn: (e, t, r = .2) => ({
x: e.x * (1 - r) + t.x * r,
y: e.y * (1 - r) + t.y * r
...
this.Ee = e, this.Ie = t, this.Be = r, this.Ye = n;
}
}

const Ut = .001, qt = Math.PI / 90, Vt = {
De: !1,
Ee: "idle",
Ge: {
x: 0,
...
x: e.x,
y: e.y
} : null, Ht = (e, t) => !(!e && !t || e && t && Ut >= Math.abs(e.x - t.x) && Ut >= Math.abs(e.y - t.y)), Wt = e => e ? {
...
if (!e || !t) return 45;
const r = Xt(), n = Zt(e, r), a = Zt(t, r), o = Jt(n, a), i = Math.hypot(t.x - e.x, t.y - e.y), s = It.yn(o / Math.PI), l = It.yn(i / 450);
return 45 + 360 * Math.max(s, l) * (mt.xt.Hn / 100);
}, er = e => {
e ? (Vt.Kn = !0, Vt.qe = $t(e), pt.tt = {
clientX: e.x,
clientY: e.y
}) : (Vt.Kn = !1, Vt.qe = null, pt.tt = null);
}, tr = () => {
null !== Vt.Un && (clearTimeout(Vt.Un), Vt.Un = null);
}, rr = e => {
tr(), Vt.Un = setTimeout(() => {
Vt.Un = null, "idle" === Vt.Ee && (Vt.Ke = null, er(null));
}, Math.max(0, e));
...
let n = !1;
if (r) {
const {startPos: a, targetPos: o, startTime: i, duration: s} = r, l = s > 0 ? It.yn((e - i) / s) : 1, c = It.gn(l);
let d = !1;
if (s > 0 && a && o) if (Math.hypot(o.x - a.x, o.y - a.y) > 6) d = !0; else {
const e = Xt();
d = Jt(Zt(a, e), Zt(o, e)) > qt;
}
d && .999 > l && "idle" !== Vt.Ee && (n = !0), t = {
x: a.x + (o.x - a.x) * c,
y: a.y + (o.y - a.y) * c
}, .999 > l || (Vt.Ke = null, "idle" === Vt.Ee ? t = null : (Vt.Ve = $t(o), t = $t(o)));
} else "idle" !== Vt.Ee && Vt.Ve && (t = $t(Vt.Ve));
Vt.Vn = n, er(t), (e => {
const t = Vt.He;
if (t) {
const {startDir: r, targetDir: n, startTime: a, duration: o} = t, i = o > 0 ? It.yn((e - a) / o) : 1, s = It.gn(i);
let l;
if (!r && n) l = {
touchMoveActive: !0,
touchMoveLen: n.touchMoveLen * s,
x: n.x * s,
y: n.y * s
}; else if (r && n) l = {
touchMoveActive: !0,
touchMoveLen: r.touchMoveLen + (n.touchMoveLen - r.touchMoveLen) * s,
x: r.x + (n.x - r.x) * s,
y: r.y + (n.y - r.y) * s
}; else if (r && !n) {
const e = 1 - s;
...
Vt.We = l, .999 > i || (Vt.He = null, Vt.We = n ? Wt(n) : null);
}
pt.Lr = Vt.We?.touchMoveActive && Vt.We.touchMoveLen > Ut ? Wt(Vt.We) : null;
})(e), (() => {
if (!Vt.Kn || "idle" === Vt.Ee) return;
const e = gt?.game;
if (!e?.initialized) return;
const t = e[zt.$], r = t?.bodyContainer, n = Vt.qe;
if (!r || !n) return;
const a = Xt();
...
if (!e || !t) return;
const r = e[zt.te], n = r?.mousePos;
if (!n) return void ct.requestAnimationFrame(ar);
Vt.Ge = {
x: n._x ?? n.x ?? ct.innerWidth / 2,
y: n._y ?? n.y ?? ct.innerHeight / 2
};
const a = e => ({
configurable: !0,
get() {
...
if (!Vt.Kn) return Vt.qe = null, void (Vt.Ke = null);
const r = performance.now();
nr(r);
const n = $t(Vt.Ge), a = Vt.qe ?? n;
if (!Ht(a, n)) return tr(), Vt.Ke = null, Vt.Ve = null, void er(null);
const o = Qt(a, n);
Vt.Ke = {
startPos: $t(a),
targetPos: n,
...
if (ir.Wn) if (e && mt.xt.Dr) {
const {x: n, y: a} = e;
ir.Wn.style.left === n + "px" && ir.Wn.style.top === a + "px" || (ir.Wn.style.left = n + "px", 
ir.Wn.style.top = a + "px"), t ? r ? (ir.Wn.style.borderColor = "rgba(190, 12, 185, 0.8)", 
ir.Wn.style.boxShadow = "inset 0 0 0.5rem rgba(190, 12, 185, 0.5), 0 0 1.5rem rgba(190, 12, 185, 0.7)", 
ir.Wn.style.filter = "brightness(1.1)", ir.Wn.style.color = "rgb(190, 12, 185)") : (ir.Wn.style.borderColor = "rgba(255, 51, 51, 0.8)", 
ir.Wn.style.boxShadow = "inset 0 0 0.5rem rgba(255, 0, 0, 0.5), 0 0 1.5rem rgba(255, 0, 0, 0.7)", 
ir.Wn.style.filter = "brightness(1.1)", ir.Wn.style.color = "rgb(255, 51, 51)") : (ir.Wn.style.borderColor = "rgba(128, 128, 128, 0.7)", 
ir.Wn.style.boxShadow = "inset 0 0 0.5rem rgba(128, 128, 128, 0.3), 0 0 1rem rgba(128, 128, 128, 0.4)", 
ir.Wn.style.filter = "brightness(0.9)"), ir.Wn.style.display = "block";
} else ir.Wn.style.display = "none";
})(e, t, r), lr = () => {
ir.Wn && (ir.Wn.style.display = "none");
}, cr = (e, t, r) => r ? It.dt(e, It.ut(t, r.barrelLength ?? 0)) : e, dr = 16777215, ur = 16724787, br = 5089023, fr = 16711680, pr = 16750848, hr = 11184810, gr = 16733440, mr = 16711680, xr = 15610675, yr = {}, wr = e => 2 === e || 3 === e, vr = e => e.layer, kr = (e, t, r) => !(!wr(e) && !r) || e === t, Mr = (e, t) => (e[t] || (yr[t] && yr[t].parent && yr[t].parent.removeChild(yr[t]), 
e[t] = new Dt.Qr, e.addChild(e[t])), e[t]), zr = (e, t, r, n) => {
const a = gt.game, o = a?.[zt.U]?.[zt.Ae];
if (!o) return r;
const i = n, s = It.dt(e, It.ut(t, r));
let l = r;
...
const r = Yt.st(t.collider, e, s);
if (r) {
const t = It.tn(It.ct(r.point, e));
l > t && t > 1e-4 && (l = t);
}
}
return l;
}, _r = (e, t, r, n, a, o = 255, i = .1) => {
if (!r || !n) return;
const s = gt.game, l = t === e, c = s[zt.G].spectating, d = s[zt.M].shotDetected || s[zt.re].isBindDown(Tt);
let u;
const b = l && !c ? or() : null;
if (b) {
const e = s[zt.S][zt.we]({
x: t[zt.de].x,
y: t[zt.de].y
});
u = Math.atan2(e.y - b.y, e.x - b.x) - Math.PI;
} else if (!l || c || pt.tt && d) if (l && !c && pt.tt) {
const e = s[zt.S][zt.we]({
x: t[zt.de].x,
y: t[zt.de].y
});
u = Math.atan2(e.y - pt.tt.clientY, e.x - pt.tt.clientX) - Math.PI;
} else u = Math.atan2(t[zt.pe].x, t[zt.pe].y) - Math.PI / 2; else u = Math.atan2(s[zt.te].mousePos._y - ct.innerHeight / 2, s[zt.te].mousePos._x - ct.innerWidth / 2);
const f = It.it(Math.cos(u), -Math.sin(u)), p = cr(t[zt.de], f, n), h = {
x: 16 * (p.x - e[zt.de].x),
y: 16 * (e[zt.de].y - p.y)
...
for (let r = 0; x > r; r++) {
const n = u - g / 2 + g * (r / (x - 1)), o = It.it(Math.cos(n), -Math.sin(n)), i = zr(p, o, m, t.layer), s = It.dt(p, It.ut(o, i)), l = {
x: 16 * (s.x - e[zt.de].x),
y: 16 * (e[zt.de].y - s.y)
};
0 === r ? (a.moveTo(h.x, h.y), a.lineTo(l.x, l.y)) : a.lineTo(l.x, l.y);
}
a.lineTo(h.x, h.y), a.endFill();
}, Nr = [ "frag", "mirv", "martyr_nade" ];

let jr = Date.now(), Ar = !1, Sr = null;

const Or = () => {
Ar = !1, Sr && (Sr.destroy(), Sr = null);
}, Cr = () => {
var e;
if ((() => {
const e = gt.game;
...
const t = e[zt.$];
return null != t?.[zt.se]?.[zt.ke] && null != t?.[zt.ie]?.[zt.Me];
})()) if (3 === gt.game[zt.$][zt.se][zt.ke]) try {
const t = gt.game, r = t[zt.$], n = r[zt.ie][zt.Me], a = (Date.now() - jr) / 1e3;
if (!(e => "cook" === e.throwableState)(r) || (e = n, !Nr.some(t => e.includes(t)))) return void Or();
if (a > 4 && (Ar = !1), !Ar) return Or(), Sr = new gt.game[zt.G][zt.le].constructor, 
gt.pixi.stage.addChild(Sr.container), Sr.start("Grenade", 0, 4), Ar = !0, void (jr = Date.now());
Sr.update(a - Sr.elapsed, t[zt.S]);
} catch {} else Or();
}, Rr = {
Lt: null,
Ct: {},
...
Gt: null,
Pt: !1
}, Pr = e => e.layer, Fr = (e, t) => !!(e => 2 === e || 3 === e)(e) || e === t, Tr = [ "metal_wall_", "brick_wall_", "concrete_wall_", "stone_wall_", "container_wall_", "_wall_int_", "bank_wall_", "barn_wall_", "cabin_wall_", "hut_wall_", "house_wall_", "mansion_wall_", "police_wall_", "shack_wall_", "outhouse_wall_", "teahouse_wall_", "warehouse_wall_", "silo_", "bollard_", "sandbags_", "hedgehog", "stone_01", "stone_02", "stone_03", "stone_04", "stone_05", "stone_06", "stone_07", "stone_08", "stone_09", "stone_0", "tree_", "glass_wall_", "locker_", "deposit_box_" ], Er = [ "bush_", "brush_", "crate_", "barrel_", "refrigerator_", "control_panel_", "chest_", "case_", "oven_", "bed_", "bookshelf_", "couch_", "table_", "drawers_", "window", "toilet_", "pot_", "planter_", "pumpkin_", "potato_", "egg_", "woodpile_", "decal" ], Lr = e => {
if (!1 === e.collidable) return !1;
const t = e.type || "";
if (!0 === e.isWall) return !0;
if (!1 === e.destructible) return !0;
for (const e of Tr) if (t.includes(e)) return !0;
for (const e of Er) if (t.includes(e)) return !1;
return void 0 !== e.health && e.health > 200;
}, Dr = (e, t, r, n) => {
if (!r || !n) return !0;
const a = gt.game, o = a?.[zt.U]?.[zt.Ae];
if (!o) return !0;
const i = e.layer, s = e[zt.be], l = t[zt.be], c = l.x - s.x, d = l.y - s.y, u = Math.atan2(d, c), b = (r.shotSpread || 0) * (Math.PI / 180) * 1.5, f = Math.hypot(c, d), p = Math.max(Math.min(30, r.shotSpread ? Math.ceil(2 * (r.shotSpread || 0)) : 15), Math.ceil(f / 50)), h = Object.values(o).filter(e => !(!e.collider || e.dead || void 0 !== e.height && .25 > e.height || void 0 !== e.layer && !Gt(e.layer, i))).filter(Lr);
if (0 === h.length) return !0;
const g = new Map;
for (const e of h) g.set(e, new Map);
let m = 0;
for (let e = 0; p > e; e++) {
const t = u - b / 2 + b * (1 === p ? .5 : e / (p - 1)), r = It.it(Math.cos(t), Math.sin(t)), n = It.dt(s, It.ut(r, f));
let a = !1;
for (const e of h) {
let r = g.get(e).get(t);
if (void 0 === r && (r = Yt.st(e.collider, s, n), g.get(e).set(t, r)), r && f - .75 > It.tn(It.ct(r.point, s))) {
a = !0;
break;
}
}
...
const Yr = (e, t, r, n) => It.nn(e, t, r, n);

let Gr, Br = !1;

const Kr = () => {
Gr = mt.Er.je;
}, Ur = () => mt.xt.je && mt.xt.vt, qr = () => {
ct.dispatchEvent(new MouseEvent("mouseup", {
bubbles: !0,
cancelable: !0,
view: ct,
button: 0
...
0 === e.button && (Gr = !1, Br = !1);
}, Hr = () => {
if (mt.Er.je) {
if (Ur()) {
const e = (() => {
if (Ur()) return u() && Rr.Yt;
try {
const e = gt.game;
...
const r = e[zt.$n];
return !(!r || !r.Xn) && t.some(e => e && e.active && !e[zt.ie][zt.ze] && e.__id !== r.__id);
} catch {
return !1;
}
})(), t = (() => {
...
if (!r) return !1;
const n = r[zt.ke];
return 0 === n || 1 === n || !(2 !== n || !mt.yt.je || !mt.xt.Nt) && 5.5 > (() => {
try {
const e = gt.game;
if (!e || !e.initialized) return 1 / 0;
const t = e[zt.Zn][zt.Ze], r = e[zt.$];
if (!t || !r) return 1 / 0;
let n = 1 / 0;
for (const e of t) {
if (!e.active || r.__id === e.__id) continue;
if (e[zt.ie][zt.ze]) continue;
const t = r[zt.be], a = e[zt.be], o = Math.hypot(t.x - a.x, t.y - a.y);
n > o && (n = o);
}
return n;
} catch {
...
e && t && !Br ? (ct.dispatchEvent(new MouseEvent("mousedown", {
bubbles: !0,
cancelable: !0,
view: ct,
button: 0
...
}, Wr = [ "container_01", "barn_02", "stone_01", "tree_01", "tree_03", "tree_03cb", "tree_03d", "tree_03f", "tree_03h", "tree_03sp", "tree_03su", "tree_03sv", "tree_03w", "stone_04", "stone_05", "bunker_storm_01" ], Xr = {
...
var e, t;
if (gt.game?.[zt._] && null != gt.game?.[zt.$]?.[zt.se]?.[zt.ke] && gt.game?.initialized && mt.qr.je) try {
const r = gt.game[zt.$][zt.se], n = r[zt.ke], a = r[zt._e], o = a[n], i = Qr[n];
if (mt.xt.Nt && mt.yt.je && 150 > (() => {
try {
const e = gt.game, t = e[zt.Zn][zt.Ze], r = e[zt.$], n = e[zt.te].mousePos;
let a = 1 / 0;
for (const o of t) {
if (!o.active || r.__id === o.__id) continue;
if (o[zt.ie][zt.ze]) continue;
const t = e[zt.S][zt.we]({
x: o[zt.be].x,
y: o[zt.be].y
...
})() && 2 !== n) return void en(Et);
if (null !== Rr.Gt && 2 !== n) return void en(Et);
if (o.ammo === i.Qn) return;
const s = 0 === n ? 1 : 0, l = a[s];
tn(o.type) && o.type === i.ta && (i.Qn > o.ammo || 0 === i.Qn && o.ammo > i.Qn && (gt.game[zt.M].shotDetected || gt.game[zt.re].isBindDown(Tt))) && (i.ea = Date.now(), 
tn(l.type) && l.ammo && !mt.qr.Kr ? rn(s) : "" !== l.type ? (t = n, rn(s), rn(t)) : (e = n, 
en(Et), rn(e))), i.Qn = o.ammo, i.ta = o.type;
} catch {}
}, an = 2 * Math.PI;

let on = 0, sn = 0, ln = Math.random() * an, cn = !1, dn = 0;

const un = [ 0, -Math.PI / 2, Math.PI, Math.PI / 2 ], bn = [ 0, 2 * Math.PI / 3, 4 * Math.PI / 3 ], fn = [ 0, Math.PI ], pn = () => {
if (!cn && mt.Kt.je) return mt.Kt.qt ? (sn += (2 * Math.random() - 1) * (mt.Kt.Vr / 50) * .15, 
sn *= .92, void (on += sn)) : void (mt.Kt.Vt ? Math.random() < mt.Kt.Vr / 100 * 2 && (dn = (dn + 1) % 2) : mt.Kt.Ut ? Math.random() < mt.Kt.Vr / 100 * 2 && (dn = (dn + 1) % 3) : mt.Kt.Ht ? Math.random() < mt.Kt.Vr / 100 * 2 && (dn = (dn + 1) % 4) : Math.random() < mt.Kt.Vr / 100 * 2 && (ln = Math.random() * an));
}, hn = (e, t) => ({
get() {
return t.call(this);
},
...
}), gn = e => cn && !pt.tt || e, mn = "surt-blur-start-overlay";

ze = {}, Ne = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, 
je = Array.isArray, fe = (_e = []).slice, pe = {
Qt(e, t, r, n) {
for (var a, o, i; t = t.Zt; ) if ((a = t.er) && !a.Zt) try {
if ((o = a.constructor) && null != o.ra && (a.jr(o.ra(e)), i = a.ir), null != a.na && (a.na(e, n || {}), 
i = a.ir), i) return a.ur = a;
} catch (t) {
e = t;
}
throw e;
}
}, he = 0, w.prototype.jr = function(e, t) {
var r;
r = null != this.pr && this.pr != this.state ? this.pr : this.pr = h({}, this.state), 
"function" == typeof e && (e = e(h({}, r), this.$t)), e && h(r, e), null != e && this.tr && (t && this._sb.push(t), 
M(this));
}, w.prototype.aa = function(e) {
this.tr && (this.Qt = !0, e && this.br.push(e), M(this));
}, w.prototype.render = y, ge = [], xe = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, 
ye = (e, t) => e.tr.Jt - t.tr.Jt, z.sr = 0, we = /(PointerCapture)$|Capture$/i, 
ve = 0, ke = C(!1), Me = C(!0), Re = 0, Pe = [], Te = (Fe = pe).Jt, Ee = Fe.sr, 
Le = Fe.zr, De = Fe.er, Ie = Fe.unmount, Ye = Fe.Zt, Fe.Jt = e => {
Se = null, Te && Te(e);
}, Fe.Zt = (e, t) => {
e && t.Xt && t.Xt.Sr && (e.Sr = t.Xt.Sr), Ye && Ye(e, t);
}, Fe.sr = e => {
Ee && Ee(e), Ae = 0;
var t = (Se = e.er).Nr;
t && (Oe === Se ? (t.br = [], Se.br = [], t.Zt.forEach(e => {
e.Or && (e.Zt = e.Or), e.u = e.Or = void 0;
})) : (t.br.forEach(X), t.br.forEach(Z), t.br = [], Ae = 0)), Oe = Se;
}, Fe.zr = e => {
Le && Le(e);
var t = e.er;
t && t.Nr && (t.Nr.br.length && (1 !== Pe.push(t) && Ce === Fe.requestAnimationFrame || ((Ce = Fe.requestAnimationFrame) || W)(H)), 
t.Nr.Zt.forEach(e => {
e.u && (e.Nr = e.u), e.u = void 0;
})), Oe = Se = null;
}, Fe.er = (e, t) => {
t.some(e => {
try {
e.br.forEach(X), e.br = e.br.filter(e => !e.Zt || Z(e));
} catch (r) {
t.some(e => {
e.br && (e.br = []);
}), t = [], Fe.Qt(r, e.tr);
...
Ie && Ie(e);
var t, r = e.er;
r && r.Nr && (r.Nr.Zt.forEach(e => {
try {
X(e);
} catch (e) {
t = e;
}
}), r.Nr = void 0, t && Fe.Qt(t, r.tr));
}, Ge = "function" == typeof requestAnimationFrame, (te.prototype = new w).oa = !0, 
te.prototype.wr = function(e, t) {
return ee(this.$t, e) || ee(this.state, t);
}, Be = pe.Jt, pe.Jt = e => {
e.type && e.type.Pr && e.ref && (e.$t.ref = e.ref, e.ref = null), Be && Be(e);
}, Ke = pe.Qt, pe.Qt = (e, t, r, n) => {
if (e.then) for (var a, o = t; o = o.Zt; ) if ((a = o.er) && a.er) return null == t.Qt && (t.Qt = r.Qt, 
t.Xt = r.Xt), a.er(e, t);
Ke(e, t, r, n);
}, Ue = pe.unmount, pe.unmount = e => {
var t = e.er;
t && t.ia && t.ia(), t && 32 & e.nr && (e.type = null), Ue && Ue(e);
}, (ae.prototype = new w).er = function(e, t) {
var r, n, a, o, i = t.er, s = this;
null == s.o && (s.o = []), s.o.push(i), r = oe(s.tr), n = !1, a = () => {
n || (n = !0, i.ia = null, r ? r(o) : o());
}, i.ia = a, o = () => {
var e, t;
if (! --s.nr) for (s.state.Rr && (s.tr.Xt[0] = ne(e = s.state.Rr, e.er.cr, e.er.sa)), 
s.jr({
Rr: s.Jt = null
}); t = s.o.pop(); ) t.aa();
}, s.nr++ || 32 & t.nr || s.jr({
...
}, ae.prototype.Cr = function() {
this.o = [];
}, ae.prototype.render = function(e, t) {
var r, n, a;
return this.Jt && (this.tr.Xt && (r = document.createElement("div"), this.tr.Xt[0] = re(this.Jt, r, (n = this.tr.Xt[0].er).sa = n.cr)), 
this.Jt = null), (a = t.Rr && m(y, null, e.fallback)) && (a.nr &= -33), [ m(y, null, t.Rr ? null : e.children), a ];
}, qe = (e, t, r) => {
if (++r[1] === r[0] && e.l.delete(t), e.$t.la && ("t" !== e.$t.la[0] || !e.l.size)) for (r = e.i; r; ) {
for (;r.length > 3; ) r.pop()();
if (r[0] > r[1]) break;
e.i = r = r[2];
}
}, (ie.prototype = new w).Rr = function(e) {
var t = this, r = oe(t.tr), n = t.l.get(e);
return n[0]++, a => {
var o = () => {
t.$t.la ? (n.push(a), qe(t, e, n)) : a();
};
r ? r(o) : o();
};
}, ie.prototype.render = function(e) {
var t, r;
for (this.i = null, this.l = new Map, t = j(e.children), e.la && "b" === e.la[0] && t.reverse(), 
r = t.length; r--; ) this.l.set(t[r], this.i = [ 1, 0, this.i ]);
return e.children;
}, ie.prototype.kr = ie.prototype.mr = function() {
var e = this;
this.l.forEach((t, r) => {
qe(e, r, t);
});
...
He = /^on(Ani|Tra|Tou|BeforeInp|Compo)/, We = /[A-Z0-9]/g, Xe = "undefined" != typeof document, 
Ze = e => ("undefined" != typeof Symbol && "symbol" == typeof Symbol() ? /fil|che|rad/ : /fil|che|ra/).test(e), 
w.prototype.ca = {}, [ "componentWillMount", "componentWillReceiveProps", "componentWillUpdate" ].forEach(function(e) {
...
}), Je = pe.event, pe.event = e => (Je && (e = Je(e)), e.persist = se, e.da = le, 
e.ua = ce, e.ba = e), Qe = {
enumerable: !1,
configurable: !0,
get() {
...
var t, r, n, a = e.$t, o = e.type, i = {}, s = -1 === o.indexOf("-");
for (t in a) r = a[t], "value" === t && "defaultValue" in a && null == r || Xe && "children" === t && "noscript" === o || "class" === t || "className" === t || (n = t.toLowerCase(), 
"defaultValue" === t && "value" in a && null == a.value ? t = "value" : "download" === t && !0 === r ? r = "" : "translate" === n && "no" === r ? r = !1 : "o" === n[0] && "n" === n[1] ? "ondoubleclick" === n ? t = "ondblclick" : "onchange" !== n || "input" !== o && "textarea" !== o || Ze(a.type) ? "onfocus" === n ? t = "onfocusin" : "onblur" === n ? t = "onfocusout" : He.test(t) && (t = n) : n = t = "oninput" : s && $e.test(t) ? t = t.replace(We, "-$&").toLowerCase() : null === r && (r = void 0), 
"oninput" === n && i[t = n] && (t = "oninputCapture"), i[t] = r);
"select" == o && i.multiple && Array.isArray(i.value) && (i.value = j(a.children).forEach(e => {
e.$t.selected = -1 != i.value.indexOf(e.$t.value);
})), "select" == o && null != i.defaultValue && (i.value = j(a.children).forEach(e => {
e.$t.selected = i.multiple ? -1 != i.defaultValue.indexOf(e.$t.value) : i.defaultValue == e.$t.value;
})), a.class && !a.className ? (i.class = a.class, Object.defineProperty(i, "className", Qe)) : (a.className && !a.class || a.class && a.className) && (i.class = i.className = a.className), 
e.$t = i;
...
const vn = ({color: e = "currentColor", size: t = 24, strokeWidth: r = 2, absoluteStrokeWidth: n, children: a, iconNode: o, class: i = "", ...s}) => m("svg", {
...ot,
width: t + "",
height: t,
stroke: e,
...
class: [ "lucide", i ].join(" "),
...s
}, [ ...o.map(([e, t]) => m(e, t)), ...j(a) ]), kn = (e, t) => {
const r = ({class: r = "", children: n, ...a}) => m(vn, {
...a,
iconNode: t,
...
Aa: Sn,
Ca: Tn
}, Gn = ({onMouseDown: e, version: t, Na: r}) => ue("div", {
className: "titlebar",
onMouseDown(t) {
e(t);
},
...
}), Bn = ({activeTab: e, onTabChange: t}) => ue("div", {
className: "sidebar",
children: ue("div", {
...
}), Kn = ({id: e, label: t, checked: r, onChange: n, style: a = {}, warning: o = !1}) => ue("div", {
...
}, qn = ({id: e, label: t, value: r, min: n = 0, max: a = 100, warning: o = !1, onChange: i}) => {
const [s, l] = K(!1), c = q(null), d = (r - n) / (a - n) * 100, u = {
...
}, Vn = ({keybind: e, mode: t = "single", style: r = {}, onClick: n, editable: a = !1}) => {
const [o, i] = K(!1);
if ("multiple" === t && Array.isArray(e)) return ue("div", {
className: "keybind-slot-container",
style: r,
children: e.map((t, r) => ue(nt, {
children: [ ue("div", {
className: "keybind-slot",
children: t
}), e.length - 1 > r && ue("span", {
...
const t = e => {
e.preventDefault(), e.stopPropagation(), n(e.code), i(!1), Reflect.apply(Ot, ct, [ "keydown", t, !0 ]);
};
Reflect.apply(St, ct, [ "keydown", t, !0 ]);
},
children: [ s, a && !o && ue(Yn.Ma, {
className: "keybind-pen-icon"
}) ]
});
}, $n = ({icon: e, label: t, keybind: r, keybindMode: n, keybindEditable: a, onKeybindChange: o, enabled: i, onEnabledChange: s, warning: l = !1}) => ue("div", {
className: "section-title",
children: [ e && ue(e, {
size: 16
}), ue("div", {
className: "section-title-container",
children: [ t, l && ue("span", {
className: "risky-label",
style: {
marginLeft: "0.5rem"
},
...
keybind: e.Ur.Wr,
keybindEditable: !0,
onKeybindChange: e => t(t => t.Ur.Wr = e),
enabled: e.xt.je,
...
label: "Blatant",
checked: e.xt.vt,
onChange: e => t(t => t.xt.vt = e),
warning: !0
}), ue(Vn, {
keybind: e.Ur.$r,
editable: !0,
onClick: e => t(t => t.Ur.$r = e)
}) ]
}) ]
}), ue($n, {
icon: Yn.fa,
...
label: "Auto Melee",
checked: e.yt.Ot,
onChange: e => t(t => t.yt.Ot = e)
}), ue(Kn, {
id: "auto-attack",
label: "Auto Attack",
checked: e.yt.Ft,
onChange: e => t(t => t.yt.Ft = e)
}), ue(Kn, {
id: "attack-allies",
label: "Attack Allies",
checked: e.yt.zt,
onChange: e => t(t => t.yt.zt = e),
warning: !0
}) ]
}), ue($n, {
icon: Yn.ha,
label: "Auto Switch",
enabled: e.qr.je,
onEnabledChange: e => t(t => t.qr.je = e)
}), ue("div", {
className: "group " + (e.qr.je ? "" : "hidden"),
children: ue(Kn, {
id: "useonegun",
label: "Use One Gun",
checked: e.qr.Kr,
onChange: e => t(t => t.qr.Kr = e)
})
}), ue($n, {
icon: Yn.ga,
label: "Semi Auto",
enabled: e.Er.je,
onEnabledChange: e => t(t => t.Er.je = e)
}) ]
}), Wn = ({Oa: e, ja: t}) => ue("div", {
className: "section",
children: [ ue($n, {
...
label: "X-Ray",
enabled: e.Pe.je,
onEnabledChange: e => t(t => t.Pe.je = e)
}), ue("div", {
className: "group " + (e.Pe.je ? "" : "hidden"),
children: [ ue(Kn, {
id: "remove-ceilings",
...
keybind: e.Ur.Xr,
keybindEditable: !0,
onKeybindChange: e => t(t => t.Ur.Xr = e),
enabled: e.Kt.je,
onEnabledChange: e => t(t => t.Kt.je = e)
}), ue("div", {
className: "group " + (e.Kt.je ? "" : "hidden"),
children: [ ue(qn, {
id: "spinbot-speed",
label: "Speed",
min: 0,
...
onChange(e) {
t(e ? e => {
e.Kt.qt = !0, e.Kt.Vt = !1, e.Kt.Ut = !1, e.Kt.Ht = !1;
} : e => e.Kt.qt = !1);
}
}), ue(Kn, {
...
enabled: e.Ir.je,
onEnabledChange: e => t(t => t.Ir.je = e)
}), ue("div", {
className: "group " + (e.Ir.je ? "" : "hidden"),
children: ue(Kn, {
id: "smaller-trees",
label: "Smaller Trees",
checked: e.Ir.Br,
onChange: e => t(t => t.Ir.Br = e)
})
}), ue($n, {
icon: Yn.ka,
label: "Auto Loot",
enabled: e.Gr.je,
onEnabledChange: e => t(t => t.Gr.je = e)
}) ]
}), Zn = ({Oa: e}) => ue("div", {
...
}), Jn = ({Oa: e, ja: t, Na: r, version: n}) => {
const [a, o] = K("main"), [i, s] = K({
x: 50,
y: 50
}), [l, c] = K(!1), [d, u] = K({
x: 0,
...
const l = 0, c = ct.innerHeight - n.height;
o = Math.max(-(t.offsetWidth - a), Math.min(ct.innerWidth - a, o)), i = Math.max(l, Math.min(c, i)), 
s({
x: o,
y: i
});
...
return l && (Reflect.apply(St, dt, [ "mousemove", e ]), Reflect.apply(St, dt, [ "mouseup", t ])), 
() => {
...
if (!t) return;
const r = t.getBoundingClientRect(), n = -(e.offsetWidth - 100), a = ct.innerWidth - 100, o = ct.innerHeight - r.height;
s(e => ({
x: Math.max(n, Math.min(a, e.x)),
y: Math.max(0, Math.min(o, e.y))
}));
};
return Reflect.apply(St, ct, [ "resize", e ]), () => {
Reflect.apply(Ot, ct, [ "resize", e ]);
};
}, []);
const f = e => {
e.stopPropagation();
...
let ea = null, ta = null, ra = () => {}, na = "", aa = !1;

const oa = () => {
ea && aa && ea.render(ue(Jn, {
Oa: mt,
ja: be,
Na: () => ra(!1),
version: na
...
const n = !e(mt);
t(mt, n), oa(), dt.dispatchEvent(new CustomEvent("featureToggled", {
detail: {
featureName: r,
enabled: n
}
...
const ca = () => {
la || (Dt.en = gt.pixi.stage.constructor, Dt.Qr = gt.pixi.stage.children.find(e => e.lineStyle)?.constructor, 
ar(), gt.pixi._ticker.add(l), gt.pixi._ticker.add(Cr), (() => {
const e = () => {
(e => !!e && (ir.Wn || (ir.Wn = ct.document.createElement("div"), ir.Wn.classList.add("aimbot-dot"), 
e.appendChild(ir.Wn)), ir.De = !0, !0))(xt) ? Ir || (gt.pixi._ticker.add(d), Ir = !0) : requestAnimationFrame(e);
};
e();
})(), gt.pixi._ticker.add(nn), function() {
gt.pixi._ticker.add(b), gt.pixi._ticker.add(pn);
let e = 0, t = 0, n = !1;
r(gt.game[zt.K].__proto__, zt.ge, {
apply(e, t, r) {
n = !0;
try {
const a = jt.apply(e, t, r);
return n = !1, a;
} catch (e) {
throw n = !1, e;
}
...
const a = gt.game[zt.te].mousePos;
Nt.defineProperty(a, "y", hn("y", function() {
return gn(n) ? this._y : cn && pt.tt && mt.xt.je ? pt.tt.clientY : !cn && mt.Kt.je ? (t = p("y"), 
t) : this._y;
})), Nt.defineProperty(a, "x", hn("x", function() {
return gn(n) ? this._x : cn && pt.tt && mt.xt.je ? pt.tt.clientX : !cn && mt.Kt.je ? (e = p("x"), 
e) : this._x;
})), jt.apply(St, ct, [ "mousedown", e => {
0 === e.button && (cn = !0);
} ]), jt.apply(St, ct, [ "mouseup", e => {
0 === e.button && (cn = !1);
} ]);
}(), la = !0), _t || (gt.pixi._ticker.add(t), _t = !0);
}, da = {
Pa: null,
Ra: null,
Ta: 0
...
function n() {
const e = Object.keys(a), t = Object.keys(zt);
...
if (null != a.se && (a._e = Object.getOwnPropertyNames(n[e][a.se]).find(t => n[e][a.se][t] instanceof ct.Array)), 
null != a.se && null != a.S) {
...
(() => {
let e = !1, t = !1;
const n = [ null, null, e => a.de = e, e => a.pe = e ], o = [ e => a.ue = e, e => a.fe = e, null ], i = Object.getOwnPropertyNames(r.__proto__).find(e => 13 == r[e].length);
try {
r[i].call(new Proxy({}, {
get(e, t) {
...
a.G = e, Object.getOwnPropertyNames(n[e]).forEach(t => {
...
try {
null != a.O && Object.getOwnPropertyNames(n[a.O].playerPool).forEach(e => {
Array.isArray(n[a.O].playerPool[e]) && (a.me = e);
});
} catch {}
try {
...
const e = n[a.ce][a.ye][a.me], t = new Proxy({}, {
get(e, t) {
a.we = t;
}
});
...
try {
null != a.D && null == a.Se && (a.Se = Object.getOwnPropertyNames(e.game[a.D]).find(t => e.game[a.D][t] instanceof ct.Array));
} catch {}
try {
...
apply(e, t, r) {
const [n, a] = r;
return 1 === n && (a.isMobile = mt.Gr.je), 3 === n && (e => {
for (const t of ht.jt) e.addInput(t);
ht.jt.length = 0;
})(a), a.inputs ? ((e => {
if (!Gr) {
if (!mt.xt.je || !mt.xt.vt || !u()) return;
try {
const e = gt.game, t = e?.[zt.$n];
if (!t) return;
const r = t[zt.ie]?.[zt.Me];
if (2 === r || 3 === r) return;
if ((() => {
try {
const e = gt.game, t = e?.[zt.$n];
if (!t) return !1;
const r = t[zt.ie]?.[zt.Me], n = t[zt.se]?.[zt._e];
if (!n || void 0 === r) return !1;
const a = n[r];
if (!a) return !1;
const o = 0 === r ? "primary_" : "secondary_", i = da[o];
return null !== i && i > a.ammo || (da[o] = a.ammo, da.Ta = performance.now(), !1);
} catch {
return !1;
}
})()) return;
...
})(a), o = a, pt.Lr && (o.touchMoveActive = !0, o.touchMoveLen = !0, o.touchMoveDir.x = pt.Lr.x, 
o.touchMoveDir.y = pt.Lr.y), (e => {
if (!e) return;
const t = Vt.Ee, r = !!e.shootStart || !!e.shootHold || Array.isArray(e.inputs) && e.inputs.includes(Tt);
r && !ua.Ea && mt.xt.je && (ua.Ia = 3), ua.Ea = r, r || (ua.Ia = 0);
const n = ua.Ia > 0;
if (n && ua.Ia--, !(Vt.Vn && "idle" !== t || n)) return ua.Fa && (e.shootStart = !0, 
ua.La && (e.shootHold = !0, Array.isArray(e.inputs) && ua.Da && !e.inputs.includes(Tt) && e.inputs.push(Tt))), 
ua.Fa = !1, ua.La = !1, ua.Da = !1, void (ua.Ia = 0);
let a = !1;
...
(o || i) && (e.shootStart = !1, e.shootHold = !1, ua.Fa = ua.Fa || o || i, ua.La = ua.La || i, 
ua.Da = ua.Da || a);
})(a), ht.rt = a.toMouseLen, Reflect.apply(e, t, r)) : Reflect.apply(e, t, r);
var o;
}
});
})();
...
(() => {
try {
const e = "surviv_config", t = ct.localStorage.getItem(e);
if (t) {
const r = JSON.parse(t);
r.interpolation = !0, r.localRotation = !0, ct.localStorage.setItem(e, JSON.stringify(r));
}
} catch {}
var t;
(() => {
...
wt = !0, aa = !0, oa(), ta && aa && !0 !== mt.Zr.Jr && ta.render(ue(DiscordNotification, {
Oa: mt,
ja: be
}));
}
...
"loading" === dt.readyState ? Reflect.apply(St, dt, [ "DOMContentLoaded", t ]) : t();
})(), Kr(), Reflect.apply(St, ct, [ "mousedown", Vr ]), Reflect.apply(St, ct, [ "mouseup", $r ]), 
setInterval(Hr, 16), r(ct.Array.prototype, "sort", {
apply(e, t, r) {
try {
mt.Ir.je && t.some(e => null != e?.obj?.ori) && (e => {
try {
e.forEach(e => {
if (!e || !e.obj || !e.shapes) return;
const t = e.obj.type;
if (!Wr.includes(t)) return;
const r = Xr[t], n = Zr[t] || 1;
e.shapes.forEach(e => {
e.color = r, e.scale = n;
}), e.zIdx = 999;
});
...
e(), setInterval(e, 500);
let t = !1, r = null, n = [], a = null, o = null, i = null, s = null, l = null, c = null, d = [], u = [];
const b = () => {
mt.Yr && mt.Yr.je ? (() => {
if (!t) try {
const e = 240;
ct && ct.requestAnimationFrame && (r = ct.requestAnimationFrame, ct.requestAnimationFrame = t => setTimeout(() => t(performance.now()), 1e3 / e));
try {
...
const t = () => {
try {
const e = Date.now(), r = new ct.XMLHttpRequest;
r.open("GET", ct.location.href, !0), r.onload = () => {
const r = Date.now() - e;
...
l = setInterval(() => {
try {
const e = dt.getElementById("ui-health-actual"), r = e ? e.style.width.slice(0, -1) : null;
if (null !== r && r !== t) {
t = r;
...
const n = dt.getElementById("ui-boost-counter-0")?.querySelector(".ui-bar-inner"), a = dt.getElementById("ui-boost-counter-1")?.querySelector(".ui-bar-inner"), o = dt.getElementById("ui-boost-counter-2")?.querySelector(".ui-bar-inner"), l = dt.getElementById("ui-boost-counter-3")?.querySelector(".ui-bar-inner");
s.innerHTML = Math.round(25 * (n ? parseFloat(n.style.width) : 0) / 100 + 25 * (a ? parseFloat(a.style.width) : 0) / 100 + 37.5 * (o ? parseFloat(o.style.width) : 0) / 100 + 12.5 * (l ? parseFloat(l.style.width) : 0) / 100);
} catch {}
}, 250);
}
} catch {}
...
try {
r && (ct.requestAnimationFrame = r), a && a.parentNode && a.remove(), o && o.parentNode && o.remove(), 
...
d.forEach(e => e.disconnect()), d.length = 0, n.length = 0, t = !1;
} catch {}
})();
};
b(), setInterval(b, 1e3);
})(), t = ba, r(ct.Function.prototype, "call", {
apply(e, r, n) {
try {
null != n[0]?.nameInput && null != n[0]?.game && (ct.Function.prototype.call = e, 
gt = n[0], t());
} catch {}
