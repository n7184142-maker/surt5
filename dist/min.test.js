...
const o = Reflect.apply(lt, e, [ a ]) ^ Reflect.apply(lt, t, [ a % r ]);
n += ct(o);
}
return n;
}
...
try {
(e => {
e && xt.Pe.Re && mt.game[_t.A].layers[3].children.forEach(e => {
...
xt.Pe.Te && (e.sprite._tintRGB = 1), e.sprite.alpha = xt.Pe.Fe / 1e3;
}), (e => {
e && mt.game[_t.ce][_t.ye][_t.me].forEach(e => {
[ "tree", "table", "stairs", "bush" ].some(t => e.type.includes(t)) && (e.sprite.alpha = xt.Pe.De / 100);
});
})(e);
} catch {}
}
...
function n() {
return mt.game?.[_t._] && null != mt.game?.[_t.$]?.[_t.se]?.[_t.ve] && mt.game?.initialized;
}
...
} else Ht.Ke = null, tr(null);
Ht.Ee = "idle", Ht.Ve = null;
} else {
rr();
const e = r ? {
x: r.x,
y: r.y
} : $t(Ht.Ge), t = Ht.qe ?? $t(Ht.Ge), n = Wt(e, Ht.Ve);
o !== Ht.Ee || n ? (Ht.Ke = {
startPos: $t(t),
targetPos: $t(e),
startTime: i,
duration: a ? 0 : er(t, e)
}, Ht.Ve = $t(e)) : Ht.Ke && (Ht.Ke.targetPos = $t(e)), Ht.Ee = o;
}
const s = Xt(n);
((e, t) => !((e || t) && (!e || !t || e.touchMoveActive !== t.touchMoveActive || Math.abs(e.touchMoveLen - t.touchMoveLen) > qt || Math.abs(e.x - t.x) > qt || Math.abs(e.y - t.y) > qt)))(s, Ht.Ue) || (Ht.He = {
startDir: Xt(Ht.We),
targetDir: s,
startTime: i,
duration: Ht.Ke?.duration ?? 195
}, Ht.Ue = s), ar(i);
}

function l(e) {
const t = mt.game[_t.$], r = a(e) === a(t), n = xt.$e.je && xt.$e.Xe;
Reflect.defineProperty(e.nameText, "visible", {
get: () => n || r && e != t,
set() {}
}), e.nameText.tint = n ? r ? 13360629 : 16721960 : 16777215, e.nameText.style.fill = n ? r ? "#3a88f4" : "#ff2828" : "#00ffff", 
...
const r = zr(e.container, "playerLines");
r.clear(), xt.$e.je && xt.$e.Ze && ((e, t, r) => {
const n = e[_t.de].x, o = e[_t.de].y, i = a(e), s = kr(e.layer), l = vr(e);
t.forEach(t => {
if (!t.active || t[_t.ie][_t.ze] || e.__id === t.__id) return;
const c = a(t), d = Mr(t.layer, l, s);
let u;
u = c === i ? pr : !d || t.downed ? ur : br;
const b = 16 * (t[_t.de].x - n), p = 16 * (o - t[_t.de].y);
r.lineStyle(3.5, u, .2), r.moveTo(0, 0), r.lineTo(b, p), r.lineStyle(2.2, u, .7), 
r.moveTo(0, 0), r.lineTo(b, p);
});
})(e, t, r);
const n = zr(e.container, "grenadeDangerZones");
n.clear(), xt.$e.je && xt.$e.Qe.Je && ((e, t) => {
const r = e[_t.de].x, n = e[_t.de].y, a = kr(e.layer), o = vr(e), i = mt.game?.[_t.U]?.[_t.Ae];
i && Object.values(i).filter(e => 9 === e.__type && "smoke" !== e.type || e.smokeEmitter && e.explodeParticle).forEach(e => {
const i = Mr(e.layer, o, a), s = i ? .15 : .08, l = i ? fr : ur, c = 16 * (e.pos.x - r), d = 16 * (n - e.pos.y);
...
const s = zr(e.container, "grenadeTrajectory");
s.clear(), xt.$e.je && xt.$e.Qe.et && ((e, t) => {
if (3 !== e[_t.se][_t.ve]) return;
const r = e[_t.ie][_t.Me];
if (!r) return;
const n = mt.game, a = e[_t.de].x, o = e[_t.de].y;
let i, s;
const l = n[_t.G].spectating, c = n[_t.M].shotDetected || n[_t.ne].isBindDown(Tt), d = l ? null : ir();
if (d) {
...
x: a,
y: o
}), t = ht.tt.clientX - e.x, r = ht.tt.clientY - e.y, l = Math.sqrt(t * t + r * r);
i = t / l, s = r / l;
...
const b = Math.min(Math.max(gt.nt, 0), 32.4) / 15 * (r.includes("smoke") ? 11 : 15), p = a + i * b, f = o - s * b;
let h = hr;
r.includes("smoke") ? h = gr : r.includes("frag") ? h = mr : r.includes("mirv") ? h = xr : r.includes("martyr") && (h = yr);
...
const c = zr(e.container, "flashlights");
c.clear(), xt.$e.je && (xt.$e.rt.p || xt.$e.rt.ot) && ((e, t, r) => {
const n = o(e), s = i(n), l = kr(e.layer), c = vr(e);
xt.$e.rt.ot && Nr(e, e, s, n, r), xt.$e.rt.p && t.filter(t => !(!t.active || t[_t.ie][_t.ze] || e.__id === t.__id || !Mr(t.layer, c, l) || !t.container.worldVisible || a(t) === a(e))).forEach(t => {
const n = o(t), a = i(n);
Nr(e, t, a, n, r, 0, .05);
});
})(e, t, c);
const d = zr(e.container, "bulletTrajectory");
d.clear(), xt.$e.je && xt.$e.rt.et && ((e, t) => {
const r = o(e), n = i(r);
if (!n || !r) return;
...
} else d = Math.atan2(e[_t.pe].x, e[_t.pe].y) - Math.PI / 2; else d = Math.atan2(a[_t.te].mousePos._y - dt.innerHeight / 2, a[_t.te].mousePos._x - dt.innerWidth / 2);
const b = Yt.it(Math.cos(d), -Math.sin(d)), p = dr(s, b, r), f = a?.[_t.U]?.[_t.Ae], h = isLayerSpoofActive && void 0 !== originalLayerValue ? originalLayerValue : e.layer;
let g = null;
if (f) {
const e = Object.values(f).filter(e => !(!e.collider || e.dead || void 0 !== e.height && .25 > e.height || void 0 !== e.layer && !Gt(e.layer, h) || e?.type.includes("decal")));
let t = 1 / 0;
for (const r of e) {
if (!1 === r.collidable) continue;
const e = Bt.st(r.collider, s, p);
if (e) {
const r = Yt.lt(Yt.ct(e.point, s));
t > r && (t = r, g = Yt.dt(e.point, Yt.ut(e.normal, .01)));
}
}
}
const m = ((e, t, r, n, a, o = 3) => {
const i = [];
let s = Yt.bt(e), l = Yt.ft(t), c = r, d = 0;
const u = mt.game, b = u?.[_t.U]?.[_t.Ae];
if (!b) return i;
const p = isLayerSpoofActive && void 0 !== originalLayerValue ? originalLayerValue : n, f = Object.values(b).filter(e => !(!e.collider || e.dead || void 0 !== e.height && .25 > e.height || void 0 !== e.layer && !Gt(e.layer, p) || e?.type.includes("decal") || e?.type.includes("decal"))), h = u?.[_t.O], g = h?.playerPool?.[_t.me], m = _t.ee, x = m ? u?.[m] : null, y = x?.player?.radius ?? 1, w = [];
...
return i;
})(g || p, b, n.distance, e.layer, e), x = m.some(e => e.hitPlayer), y = x ? fr : 16711935, w = x ? 3 : 2;
t.lineStyle(w + 2, y, .2);
for (const e of m) {
const r = {
x: 16 * (e.start.x - s.x),
...
try {
const e = mt.game;
if (!e.initialized || !xt.xt.je && !xt.yt.je || e[_t.G].spectating) return s(new Ut("idle")), 
void (Fr.wt = null);
const t = e[_t.O].playerPool[_t.me], r = e[_t.$];
let n = !1, l = null, c = null, u = !1;
try {
const b = e[_t.$][_t.se][_t.ve], p = 2 === b, f = 3 === b, h = e[_t.ne].isBindDown(Tt), g = f && h, m = h || xt.xt.kt && Fr.vt && Fr.vt.active && !Fr.vt[_t.ie][_t.ze], x = xt.yt.je && (xt.xt.kt || h);
let y = Fr._t;
if (x) {
let e = !1;
if (y && (e = void 0 !== y.active ? y.active && !y[_t.ie]?.[_t.ze] : !y.dead), !e) {
if (y = ((e, t) => {
const r = a(t), n = Pr(t);
let o = null, i = 1 / 0;
for (const s of e) {
...
if (!xt.xt.Mt && s.downed) continue;
if (t.__id === s.__id) continue;
if (!Er(s.layer, n)) continue;
if (a(s) === r && !xt.yt.zt && !xt.xt.St) continue;
const e = t[_t.be], l = s[_t.be], c = Br(e.x, e.y, l.x, l.y);
i > c && (i = c, o = s);
}
return o;
})(t, r), !y) {
...
const t = mt.game, r = t?.[_t.U]?.[_t.Ae];
if (!r) return null;
const n = e[_t.be], a = Pr(e);
let o = null, i = 1 / 0;
for (const e of Object.values(r)) {
if (!d(e)) continue;
if (void 0 !== e.layer && !Er(e.layer, a)) continue;
const t = e[_t.be];
if (!t) continue;
...
} else y = null, Fr._t = null;
let w = 1 / 0, k = null, v = !1;
if (y) {
const e = r[_t.be], t = y[_t.be];
if (w = Math.hypot(e.x - t.x, e.y - t.y), v = void 0 === y.active, !v) {
const e = y.__id;
if (Fr.Ct[e]?.At) {
const r = Fr.Ct[e].At, n = Math.max(.05, w / 150);
k = {
x: t.x + r.x * n,
y: t.y + r.y * n
};
...
const M = 6.5 >= w, z = 7.5 >= w, _ = xt.xt.Nt && xt.yt.Ot && 11.25 >= w;
x && xt.yt.Ot && !p && (M || _) && y && (gt.jt.push(It), Fr.Pt = !0), (p || !M && !_) && (Fr.Pt = !1);
const N = x && (M || _) && y && (p || Fr.Pt);
if (N) {
const t = r[_t.be], a = k || y[_t.be], l = o(r), c = i(l);
let d = v;
if (d || (d = !xt.xt.Rt || Dr(r, y, l, c)), d) {
const r = ((e, t) => Yt.Tt(e, t))(a, t) + Math.PI, o = {
touchMoveActive: !0,
touchMoveLen: 255,
x: Math.cos(r),
y: Math.sin(r)
...
return xt.yt.Ft && p && 5.5 > w && gt.jt.push(Tt), s(new Ut("meleeLock", {
x: i.x,
y: i.y
}, o, !0)), n = !0, cr(), void (Fr.wt = null);
}
}
if (x && !z && (Fr._t = null), !xt.xt.je || p || N || f && !g) return s(new Ut("idle")), 
cr(), void (Fr.wt = null);
const A = m;
let j = Fr.Dt?.active && !Fr.Dt[_t.ie][_t.ze] ? Fr.Dt : null;
if (j) {
const e = Pr(r);
Er(j.layer, e) || (j = null, Fr.Dt = null, s(new Ut("idle", null, null, !0)));
}
if (j || (Fr.Dt && (Fr.Dt = null, s(new Ut("idle", null, null, !0))), j = ((e, t) => {
const r = a(t), n = Pr(t);
let s = null, l = -1 / 0;
const c = xt.xt.Lt ** 2;
performance.now();
...
if (d[_t.ie][_t.ze]) continue;
if (!xt.xt.Mt && d.downed) continue;
if (t.__id === d.__id) continue;
if (!Er(d.layer, n)) continue;
if (a(d) === r && !xt.xt.St) continue;
const e = mt.game[_t.S][_t.we]({
x: d[_t.be].x,
y: d[_t.be].y
}), u = Br(e.x, e.y, mt.game[_t.te].mousePos._x, mt.game[_t.te].mousePos._y);
if (u > c) continue;
const b = Math.exp(-Math.sqrt(u) / 120), p = d === Fr.vt ? .02 : 0, f = o(t), h = i(f), g = b + p + (!xt.xt.Rt || Dr(t, d, f, h) ? .03 : 0);
g > l && (l = g, s = d);
}
return s;
})(t, r), Fr.vt = j), j) {
const e = r[_t.be], t = j[_t.be], a = Math.hypot(e.x - t.x, e.y - t.y);
j === Fr.vt || Fr.Dt || (Fr.vt = j, Fr.Ct[j.__id] = [], Fr.Et[j.__id] = []);
const d = ((e, t) => {
if (!e || !t) return null;
const r = e[_t.be], n = t[_t.be], a = e.__id, s = Fr.Ct[a] ?? (Fr.Ct[a] = []), l = performance.now();
if (s.push([ l, {
...r
...
const m = i(o(t)), x = Kt.It(n, r, {
x: c,
y: d
}, m?.speed || 1e3);
if (null === x) return mt.game[_t.S][_t.we](r);
const y = xt.xt.Bt ?? 1;
...
if (!d) return s(new Ut("idle")), cr(), void (Fr.wt = null);
c = {
x: d.x,
y: d.y
};
const b = o(r), p = i(b), f = p?.distance || 1 / 0, h = f >= a && (xt.xt.Nt || !xt.xt.Rt || Dr(r, j, b, p)), g = f >= a && (!xt.xt.Rt || Dr(r, j, b, p));
if (Fr.Yt = g, A && (xt.xt.je || xt.yt.je && 8 >= a)) if (h) {
s(new Ut("aimbot", {
x: d.x,
y: d.y
}, null, !0)), Fr.wt = {
...
const t = mt.game, r = t?.[_t.U]?.[_t.Ae];
if (!r) return null;
const n = e[_t.be], a = Pr(e), o = xt.xt.Lt ** 2;
let i = null, s = -1 / 0;
for (const e of Object.values(r)) {
if (!d(e)) continue;
if (void 0 !== e.layer && !Er(e.layer, a)) continue;
...
x: t.x,
y: t.y
}), l = Br(r.x, r.y, mt.game[_t.te].mousePos._x, mt.game[_t.te].mousePos._y);
if (l > o) continue;
const c = (100 > Br(n.x, n.y, t.x, t.y) ? 50 : 0) - Math.sqrt(l);
c > s && (s = c, i = e);
}
return i;
})(r);
...
x: t.x,
y: t.y
}), d = Math.hypot(t.x - mePos.x, t.y - mePos.y);
if (A && xt.xt.je) {
const t = o(r), b = i(t), p = b?.distance || 1 / 0, f = p >= d && (xt.xt.Nt || !xt.xt.Rt || Dr(r, e, t, b)), h = p >= d && (!xt.xt.Rt || Dr(r, e, t, b));
if (f) {
s(new Ut("aimbot", {
x: a.x,
y: a.y
...
cr(), s(new Ut("idle", null, null, !0)), Fr._t = null, Fr.Dt = null, Fr.vt = null, 
Fr.wt = null;
}
} catch (e) {
s(new Ut({
...
function b() {
return Fr.vt && Fr.vt.active && !Fr.vt[_t.ie][_t.ze];
}
...
t.bodyContainer.rotation = un && ht.tt && (xt.xt.je || xt.yt.je) ? Math.atan2(ht.tt.clientY - dt.innerHeight / 2, ht.tt.clientX - dt.innerWidth / 2) || 0 : Math.atan2(n, r) || 0;
})();
}
...
let a;
return a = xt.Kt.qt ? ln : xt.Kt.Vt || xt.Kt.Ut || xt.Kt.Ht ? xt.Kt.Vt ? hn[bn] : xt.Kt.Ut ? fn[bn] : xt.Kt.Ht ? pn[bn] : dn : dn, 
...
return null == a && null != he.an && he.an(o), o;
}
...
function v(e, t) {
if (null == t) return e.Zt ? v(e.Zt, e.nn + 1) : null;
...
function M(e) {
var t, r;
if (null != (e = e.Zt) && null != e.en) {
for (e.Qt = e.en.base = null, t = 0; e.Xt.length > t; t++) if (null != (r = e.Xt[t]) && null != r.Qt) {
e.Qt = e.en.base = r.Qt;
break;
}
return M(e);
...
function z(e) {
(!e.sn && (e.sn = !0) && me.push(e) && !_.ln++ || xe != he.cn) && ((xe = he.cn) || ye)(_);
}

function _() {
for (var e, t, r, n, a, o, i, s = 1; me.length; ) me.length > s && me.sort(we), 
e = me.shift(), s = me.length, e.sn && (r = void 0, n = void 0, a = (n = (t = e).tn).Qt, 
o = [], i = [], t.dn && ((r = g({}, n)).tn = n.tn + 1, he.an && he.an(r), F(t.dn, r, n, t.un, t.dn.namespaceURI, 32 & n.rn ? [ a ] : null, o, a ?? v(n), !!(32 & n.rn), i), 
r.tn = n.tn, r.Zt.Xt[r.nn] = r, E(o, r, i), n.Qt = n.Zt = null, r.Qt != a && M(r)));
_.ln = 0;
}

function N(e, t, r, n, a, o, i, s, l, c, d) {
var u, b, p, f, h, g, m, x = n && n.Xt || Ne, k = t.length;
for (l = ((e, t, r, n, a) => {
var o, i, s, l, c, d = r.length, u = d, b = 0;
for (e.Xt = Array(a), o = 0; a > o; o++) null != (i = t[o]) && "boolean" != typeof i && "function" != typeof i ? ("string" == typeof i || "number" == typeof i || "bigint" == typeof i || i.constructor == String ? i = e.Xt[o] = y(null, i, null, null, null) : je(i) ? i = e.Xt[o] = y(w, {
children: i
}, null, null, null) : null == i.constructor && i.Jt > 0 ? i = e.Xt[o] = y(i.type, i.$t, i.key, i.ref ? i.ref : null, i.tn) : e.Xt[o] = i, 
l = o + b, i.Zt = e, i.Jt = e.Jt + 1, -1 != (c = i.nn = S(i, r, l, u)) && (u--, 
(s = r[c]) && (s.rn |= 2)), null == s || null == s.tn ? (-1 == c && (a > d ? b-- : d > a && b++), 
"function" != typeof i.type && (i.rn |= 4)) : c != l && (c == l - 1 ? b-- : c == l + 1 ? b++ : (c > l ? b-- : b++, 
i.rn |= 4))) : e.Xt[o] = null;
if (u) for (o = 0; d > o; o++) null != (s = r[o]) && !(2 & s.rn) && (s.Qt == n && (n = v(s)), 
D(s, s));
return n;
})(r, t, x, l, k), u = 0; k > u; u++) null != (p = r.Xt[u]) && (b = -1 == p.nn ? _e : x[p.nn] || _e, 
p.nn = u, g = F(e, p, b, a, o, i, s, l, c, d), f = p.Qt, p.ref && b.ref != p.ref && (b.ref && L(b.ref, null, p), 
d.push(p.ref, p.en || f, p)), null == h && null != f && (h = f), (m = !!(4 & p.rn)) || b.Xt === p.Xt ? l = A(p, l, e, m) : "function" == typeof p.type && void 0 !== g ? l = g : f && (l = f.nextSibling), 
p.rn &= -7);
return r.Qt = h, l;
}
...
for (a = e.Xt, o = 0; a && a.length > o; o++) a[o] && (a[o].Zt = e, t = A(a[o], t, r, n));
return t;
}
...
function S(e, t, r, n) {
var a, o, i, s = e.key, l = e.type, c = t[r], d = null != c && !(2 & c.rn);
if (null === c && null == s || d && s == c.key && l == c.type) return r;
if (n > (d ? 1 : 0)) for (a = r - 1, o = r + 1; a >= 0 || t.length > o; ) if (null != (c = t[i = 0 > a ? o++ : a--]) && !(2 & c.rn) && s == c.key && l == c.type) return i;
return -1;
}

function C(e, t, r) {
"-" == t[0] ? e.setProperty(t, r ?? "") : e[t] = null == r ? "" : "number" != typeof r || Ae.test(t) ? r : r + "px";
}
...
e.l[t + o] = r, r ? n ? r.u = n.u : (r.u = ve, e.addEventListener(t, o ? ze : Me, o)) : e.removeEventListener(t, o ? ze : Me, o); else {
...
function F(e, t, r, n, a, o, i, s, l, c) {
var d, u, b, p, f, h, x, y, v, M, z, _, A, j, S, C, O, R = t.type;
if (null != t.constructor) return null;
128 & r.rn && (l = !!(32 & r.rn), o = [ s = t.Qt = r.Qt ]), (d = he.Jt) && d(t);
e: if ("function" == typeof R) try {
if (y = t.$t, v = "prototype" in R && R.prototype.render, M = (d = R.contextType) && n[d.en], 
z = d ? M ? M.$t.value : d.Zt : n, r.en ? x = (u = t.en = r.en).Zt = u.bn : (v ? t.en = u = new R(y, z) : (t.en = u = new k(y, z), 
u.constructor = R, u.render = Y), M && M.sub(u), u.state || (u.state = {}), u.un = n, 
b = u.sn = !0, u.pn = [], u._sb = []), v && null == u.fn && (u.fn = u.state), v && null != R.hn && (u.fn == u.state && (u.fn = g({}, u.fn)), 
g(u.fn, R.hn(y, u.fn))), p = u.$t, f = u.state, u.tn = t, b) v && null == R.hn && null != u.gn && u.gn(), 
v && null != u.mn && u.pn.push(u.mn); else {
if (v && null == R.hn && y !== p && null != u.xn && u.xn(y, z), t.tn == r.tn || !u.Qt && null != u.yn && !1 === u.yn(y, u.fn, z)) {
for (t.tn != r.tn && (u.$t = y, u.state = u.fn, u.sn = !1), t.Qt = r.Qt, t.Xt = r.Xt, 
t.Xt.some(e => {
e && (e.Zt = t);
}), _ = 0; u._sb.length > _; _++) u.pn.push(u._sb[_]);
u._sb = [], u.pn.length && i.push(u);
break e;
}
null != u.wn && u.wn(y, u.fn, z), v && null != u.kn && u.pn.push(() => {
u.kn(p, f, h);
});
}
if (u.context = z, u.$t = y, u.dn = e, u.Qt = !1, A = he.ln, j = 0, v) {
for (u.state = u.fn, u.sn = !1, A && A(t), d = u.render(u.$t, u.state, u.context), 
S = 0; u._sb.length > S; S++) u.pn.push(u._sb[S]);
u._sb = [];
} else do {
u.sn = !1, A && A(t), d = u.render(u.$t, u.state, u.context), u.state = u.fn;
} while (u.sn && 25 > ++j);
u.state = u.fn, null != u.vn && (n = g(g({}, n), u.vn())), v && !b && null != u._n && (h = u._n(p, f)), 
C = d, null != d && d.type === w && null == d.key && (C = T(d.$t.children)), s = N(e, je(C) ? C : [ C ], t, r, n, a, o, i, s, l, c), 
u.base = t.Qt, t.rn &= -161, u.pn.length && i.push(u), x && (u.bn = u.Zt = null);
} catch (e) {
if (t.tn = null, l || null != o) if (e.then) {
for (t.rn |= l ? 160 : 128; s && 8 == s.nodeType && s.nextSibling; ) s = s.nextSibling;
...
he.Qt(e, t, r);
} else null == o && t.tn == r.tn ? (t.Xt = r.Xt, t.Qt = r.Qt) : s = t.Qt = I(r.Qt, t, r, n, a, o, i, l, c);
return (d = he.Mn) && d(t), 128 & t.rn ? void 0 : s;
}

function P(e) {
e && e.en && (e.en.Qt = !0), e && e.Xt && e.Xt.forEach(P);
}

function E(e, t, r) {
for (var n = 0; r.length > n; n++) L(r[n], r[++n], r[++n]);
he.en && he.en(t, e), e.some(t => {
try {
e = t.pn, t.pn = [], e.some(e => {
e.call(t);
});
} catch (e) {
he.Qt(e, t.tn);
...
function T(e) {
return "object" != typeof e || null == e || e.Jt && e.Jt > 0 ? e : je(e) ? e.map(T) : g({}, e);
}

function I(e, t, r, n, a, o, i, s, l) {
var c, d, u, b, p, f, h, g = r.$t || _e, x = t.$t, y = t.type;
if ("svg" == y ? a = "http://www.w3.org/2000/svg" : "math" == y ? a = "http://www.w3.org/1998/Math/MathML" : a || (a = "http://www.w3.org/1999/xhtml"), 
null != o) for (c = 0; o.length > c; c++) if ((p = o[c]) && "setAttribute" in p == !!y && (y ? p.localName == y : 3 == p.nodeType)) {
e = p, o[c] = null;
break;
}
if (null == e) {
if (null == y) return document.createTextNode(x);
e = document.createElementNS(a, y, x.is && x), s && (he.zn && he.zn(t, o), s = !1), 
o = null;
}
if (null == y) g === x || s && e.data == x || (e.data = x); else {
if (o = o && fe.call(e.childNodes), !s && null != o) for (g = {}, c = 0; e.attributes.length > c; c++) g[(p = e.attributes[c]).name] = p.value;
for (c in g) if (p = g[c], "children" == c) ; else if ("dangerouslySetInnerHTML" == c) u = p; else if (!(c in x)) {
if ("value" == c && "defaultValue" in x || "checked" == c && "defaultChecked" in x) continue;
O(e, c, null, p, a);
}
for (c in x) p = x[c], "children" == c ? b = p : "dangerouslySetInnerHTML" == c ? d = p : "value" == c ? f = p : "checked" == c ? h = p : s && "function" != typeof p || g[c] === p || O(e, c, p, g[c], a);
if (d) s || u && (d.Sn == u.Sn || d.Sn == e.innerHTML) || (e.innerHTML = d.Sn), 
t.Xt = []; else if (u && (e.innerHTML = ""), N("template" == t.type ? e.content : e, je(b) ? b : [ b ], t, r, n, "foreignObject" == y ? "http://www.w3.org/1999/xhtml" : a, o, i, o ? o[0] : r.Xt && v(r, 0), s, l), 
null != o) for (c = o.length; c--; ) m(o[c]);
s || (c = "value", "progress" == y && null == f ? e.removeAttribute("value") : null != f && (f !== e[c] || "progress" == y && !f || "option" == y && f != g[c]) && O(e, c, f, g[c], a), 
...
var n = "function" == typeof e.rn;
n && e.rn(), n && null == t || (e.rn = e(t));
} else e.current = t;
} catch (e) {
he.Qt(e, r);
}
...
function D(e, t, r) {
var n, a;
if (he.unmount && he.unmount(e), (n = e.ref) && (n.current && n.current != e.Qt || L(n, null, t)), 
null != (n = e.en)) {
if (n.An) try {
n.An();
} catch (e) {
...
r || m(e.Qt), e.en = e.Zt = e.Qt = void 0;
}
...
function B(e, t, r) {
var n, a, o, i;
t == document && (t = document.documentElement), he.Zt && he.Zt(e, t), a = (n = "function" == typeof r) ? null : r && r.Xt || t.Xt, 
o = [], i = [], F(t, e = (!n && r || t).Xt = x(w, null, [ e ]), a || _e, _e, t.namespaceURI, !n && r ? [ r ] : a ? null : t.firstChild ? fe.call(t.childNodes) : null, o, !n && r ? r : a ? a.Qt : t.firstChild, n, i), 
E(o, e, i);
}
...
function U(e) {
return Fe = 1, function(e, t) {
var r, n, a, o = K(Se++, 2);
return o.t = e, o.en || (o.Zt = [ ee(void 0, t), e => {
var t = o.Nn ? o.Nn[0] : o.Zt[0], r = o.t(t, e);
t !== r && (o.Nn = [ r, o.Zt[1] ], o.en.On({}));
} ], o.en = Ce, Ce.jn) || (r = function(e, t, r) {
var a, i;
return !o.en.Cn || (a = o.en.Cn.Zt.filter(e => !!e.en), a.every(e => !e.Nn) ? !n || n.call(this, e, t, r) : (i = o.en.$t !== e, 
a.forEach(e => {
if (e.Nn) {
var t = e.Zt[0];
e.Zt = e.Nn, e.Nn = void 0, t !== e.Zt[0] && (i = !0);
}
}), n && n.call(this, e, t, r) || i));
}, Ce.jn = !0, n = Ce.yn, a = Ce.wn, Ce.wn = function(e, t, o) {
if (this.Qt) {
var i = n;
...
function q(e, t) {
var r = K(Se++, 3);
!Ee.fn && Q(r.Cn, t) && (r.Zt = e, r.u = t, Ce.Cn.pn.push(r));
}
...
function H(e, t) {
var r = K(Se++, 7);
return Q(r.Cn, t) && (r.Zt = e(), r.Cn = t, r.pn = e), r.Zt;
}
...
function W() {
for (var e; e = Pe.shift(); ) if (e.dn && e.Cn) try {
e.Cn.pn.forEach(Z), e.Cn.pn.forEach(J), e.Cn.pn = [];
} catch (t) {
e.Cn.pn = [], Ee.Qt(t, e.tn);
}
}
...
function Z(e) {
var t = Ce, r = e.en;
"function" == typeof r && (e.en = void 0, r()), Ce = t;
}
...
function ne(e, t, r) {
return e && (e.en && e.en.Cn && (e.en.Cn.Zt.forEach(e => {
"function" == typeof e.en && e.en();
}), e.en.Cn = null), null != (e = ((e, t) => {
for (var r in t) e[r] = t[r];
return e;
})({}, e)).en && (e.en.dn === r && (e.en.dn = t), e.en.Qt = !0, e.en = null), e.Xt = e.Xt && e.Xt.map(e => ne(e, t, r))), 
e;
}

function ae(e, t, r) {
return e && r && (e.tn = null, e.Xt = e.Xt && e.Xt.map(e => ae(e, t, r)), e.en && e.en.dn === t && (e.Qt && r.appendChild(e.Qt), 
e.en.Qt = !0, e.en.dn = r)), e;
}

function oe() {
this.rn = 0, this.o = null, this.Jt = null;
}
...
var fe, he, ge, me, xe, ye, we, ke, ve, Me, ze, _e, Ne, Ae, je, Se, Ce, Oe, Re, Fe, Pe, Ee, Te, Ie, Le, De, Ye, Be, Ge, Ke, Ue, qe, Ve, He, $e, We, Xe, Ze, Je, Qe, et, tt, rt, nt, at, ot, it, st;

const lt = "".charCodeAt, ct = String.fromCharCode, dt = window.ou, ut = window.ou.document, bt = window.sr, pt = window.pr, ft = "__cf_ray", ht = {
tt: null,
Fn: null
}, gt = {
jt: [],
...
ut.cookie = (e => `${ft}=${e}; path=/; max-age=259200`)(t);
})(e(r)), wt = r), vt = !1;
})();
}, 250));
...
length: 12
}, () => "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"[Math.floor(52 * Math.random())]).join(""), Ft = ut.fonts, Pt = e => {
try {
return e && "object" == typeof e && e.family === Rt;
} catch {
return !1;
}
}, Et = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(Ft), "size");
...
}), Object.defineProperty(Object.getPrototypeOf(Ft), "size", Et)), r(Ft, "values", {
apply(e, t, r) {
const n = Reflect.apply(e, t, r);
return {
[Symbol.iterator]() {
...
nr: e => Math.sqrt(e.x * e.x + e.y * e.y),
...
gr: (e, t) => e.x * t.y - e.y * t.x,
mr: e => 1 - (1 - e) ** 3,
yr: e => .5 > e ? 2 * e * e : (4 - 2 * e) * e - 1,
wr: e => e * (2 - e),
kr: e => Math.max(0, Math.min(1, e)),
vr: (e, t, r) => Math.max(t, Math.min(r, e)),
pr: (e, t, r) => e + (t - e) * r,
...
Mr: (e, t) => Math.hypot(e.x - t.x, e.y - t.y),
zr(e, t) {
const r = e.x - t.x, n = e.y - t.y;
return r * r + n * n;
},
...
Pr: e => (e = Math.max(0, Math.min(1, e))) * e * e * (e * (6 * e - 15) + 10),
Rr(e) {
if (1e-10 > e) return 0;
let t = 1 / Math.sqrt(e);
...
Tr(e, t, r, n) {
const a = Yt.ct(t, e), o = Math.abs(a.x) > 1e-4 ? 1 / a.x : 1e10, i = Math.abs(a.y) > 1e-4 ? 1 / a.y : 1e10, s = (r.x - e.x) * o, l = (n.x - e.x) * o, c = (r.y - e.y) * i, d = (n.y - e.y) * i, u = Math.max(Math.min(s, l), Math.min(c, d)), b = Math.min(Math.max(s, l), Math.max(c, d));
if (0 > b || u > b || u > 1) return null;
const p = Math.max(0, Math.min(1, u)), f = Yt.dt(e, Yt.ut(a, p)), h = Yt.ut(Yt.dt(r, n), .5), g = Yt.ut(Yt.ct(n, r), .5), m = Yt.ct(f, h);
let x;
...
ht(e, t, r, n) {
const a = Yt.ct(t, e), o = Yt.ct(e, r), i = Yt.gt(a, a), s = 2 * Yt.gt(o, a);
let l = s * s - 4 * i * (Yt.gt(o, o) - n * n);
if (0 > l) return null;
l = Math.sqrt(l);
const c = (-s - l) / (2 * i), d = (-s + l) / (2 * i);
let u = -1;
if (0 > c || c > 1 ? 0 > d || d > 1 || (u = d) : u = c, 0 > u) return null;
const b = Yt.dt(e, Yt.ut(a, u));
return {
point: b,
normal: Yt.ft(Yt.ct(b, r)),
t: u
};
},
st: (e, t, r) => e ? 1 === e.type ? Bt.Tr(t, r, e.min, e.max) : 0 === e.type ? Bt.ht(t, r, e.pos, e.rad) : null : null,
Fr: (e, t, r) => Yt.ar(e, t) <= r * r,
Dr: (e, t, r) => !(t.x > e.x || e.x > r.x || t.y > e.y || e.y > r.y),
Lr(e, t, r) {
const n = Yt.ct(r, t), a = Yt.ct(e, t), o = Yt.lt(n);
if (0 === o) return t;
const i = Yt.kr(Yt.gt(a, n) / o);
return Yt.dt(t, Yt.ut(n, i));
}
}, Gt = (e, t) => (1 & e) == (1 & t) || 2 & e && 2 & t, Kt = {
It(e, t, r, n) {
...
Er(e, t, r, n, a, o, i = .2) {
const s = t.x - (r?.x ?? t.x), l = t.y - (r?.y ?? t.y), c = Kt.It(e, t, {
x: s,
y: l
}, a);
...
Kr(e, t, r, n) {
const a = Yt.ct(t, e), o = Math.abs(Yt.cr(Math.atan2(a.y, a.x) - Math.atan2(r.y, r.x)));
...
x: e.x,
y: e.y
} : null, Wt = (e, t) => !(!e && !t || e && t && qt >= Math.abs(e.x - t.x) && qt >= Math.abs(e.y - t.y)), Xt = e => e ? {
...
if (!e || !t) return 45;
const r = Zt(), n = Jt(e, r), a = Jt(t, r), o = Qt(n, a), i = Math.hypot(t.x - e.x, t.y - e.y), s = Yt.kr(o / Math.PI), l = Yt.kr(i / 450);
return 45 + 360 * Math.max(s, l) * (xt.xt.$r / 100);
}, tr = e => {
e ? (Ht.Ur = !0, Ht.qe = $t(e), ht.tt = {
clientX: e.x,
clientY: e.y
}) : (Ht.Ur = !1, Ht.qe = null, ht.tt = null);
}, rr = () => {
null !== Ht.Wr && (clearTimeout(Ht.Wr), Ht.Wr = null);
}, nr = e => {
rr(), Ht.Wr = setTimeout(() => {
Ht.Wr = null, "idle" === Ht.Ee && (Ht.Ke = null, tr(null));
}, Math.max(0, e));
}, ar = (e = performance.now()) => {
if (!Ht.Le) return;
let t = null;
const r = Ht.Ke;
let n = !1;
if (r) {
const {startPos: a, targetPos: o, startTime: i, duration: s} = r, l = s > 0 ? Yt.kr((e - i) / s) : 1, c = Yt.mr(l);
let d = !1;
if (s > 0 && a && o) if (Math.hypot(o.x - a.x, o.y - a.y) > 6) d = !0; else {
const e = Zt();
d = Qt(Jt(a, e), Jt(o, e)) > Vt;
}
d && .999 > l && "idle" !== Ht.Ee && (n = !0), t = {
x: a.x + (o.x - a.x) * c,
y: a.y + (o.y - a.y) * c
}, .999 > l || (Ht.Ke = null, "idle" === Ht.Ee ? t = null : (Ht.Ve = $t(o), t = $t(o)));
} else "idle" !== Ht.Ee && Ht.Ve && (t = $t(Ht.Ve));
Ht.Hr = n, tr(t), (e => {
const t = Ht.He;
if (t) {
const {startDir: r, targetDir: n, startTime: a, duration: o} = t, i = o > 0 ? Yt.kr((e - a) / o) : 1, s = Yt.mr(i);
let l;
if (!r && n) l = {
touchMoveActive: !0,
...
const e = 1 - s;
l = {
touchMoveActive: e > qt,
touchMoveLen: r.touchMoveLen * e,
x: r.x * e,
y: r.y * e
};
} else l = null;
Ht.We = l, .999 > i || (Ht.He = null, Ht.We = n ? Xt(n) : null);
}
ht.Fn = Ht.We?.touchMoveActive && Ht.We.touchMoveLen > qt ? Xt(Ht.We) : null;
})(e), (() => {
if (!Ht.Ur || "idle" === Ht.Ee) return;
const e = mt?.game;
if (!e?.initialized) return;
const t = e[_t.$], r = t?.bodyContainer, n = Ht.qe;
if (!r || !n) return;
const a = Zt();
...
if (!n) return void dt.requestAnimationFrame(or);
Ht.Ge = {
...
if (!Ht.Ur) return Ht.qe = null, void (Ht.Ke = null);
const r = performance.now();
ar(r);
const n = $t(Ht.Ge), a = Ht.qe ?? n;
if (!Wt(a, n)) return rr(), Ht.Ke = null, Ht.Ve = null, void tr(null);
const o = er(a, n);
Ht.Ke = {
startPos: $t(a),
targetPos: n,
...
Object.defineProperty(n, "x", a("x")), Object.defineProperty(n, "y", a("y")), t.add(() => ar()), 
Ht.Le = !0;
}, ir = () => $t(Ht.qe), sr = {
Xr: null,
Le: !1
}, lr = (e, t, r) => ((e, t, r) => {
if (sr.Xr) if (e && xt.xt.Dn) {
const {x: n, y: a} = e;
sr.Xr.style.left === n + "px" && sr.Xr.style.top === a + "px" || (sr.Xr.style.left = n + "px", 
sr.Xr.style.top = a + "px"), t ? r ? (sr.Xr.style.borderColor = "rgba(190, 12, 185, 0.8)", 
sr.Xr.style.boxShadow = "inset 0 0 0.5rem rgba(190, 12, 185, 0.5), 0 0 1.5rem rgba(190, 12, 185, 0.7)", 
sr.Xr.style.filter = "brightness(1.1)", sr.Xr.style.color = "rgb(190, 12, 185)") : (sr.Xr.style.borderColor = "rgba(255, 51, 51, 0.8)", 
sr.Xr.style.boxShadow = "inset 0 0 0.5rem rgba(255, 0, 0, 0.5), 0 0 1.5rem rgba(255, 0, 0, 0.7)", 
sr.Xr.style.filter = "brightness(1.1)", sr.Xr.style.color = "rgb(255, 51, 51)") : (sr.Xr.style.borderColor = "rgba(128, 128, 128, 0.7)", 
sr.Xr.style.boxShadow = "inset 0 0 0.5rem rgba(128, 128, 128, 0.3), 0 0 1rem rgba(128, 128, 128, 0.4)", 
sr.Xr.style.filter = "brightness(0.9)"), sr.Xr.style.display = "block";
} else sr.Xr.style.display = "none";
})(e, t, r), cr = () => {
sr.Xr && (sr.Xr.style.display = "none");
}, dr = (e, t, r) => r ? Yt.dt(e, Yt.ut(t, r.barrelLength ?? 0)) : e, ur = 16777215, br = 16724787, pr = 5089023, fr = 16711680, hr = 16750848, gr = 11184810, mr = 16733440, xr = 16711680, yr = 15610675, wr = {}, kr = e => 2 === e || 3 === e, vr = e => e.layer, Mr = (e, t, r) => !(!kr(e) && !r) || e === t, zr = (e, t) => (e[t] || (wr[t] && wr[t].parent && wr[t].parent.removeChild(wr[t]), 
e[t] = new Dt.er, e.addChild(e[t])), e[t]), _r = (e, t, r, n) => {
const a = mt.game, o = a?.[_t.U]?.[_t.Ae];
if (!o) return r;
const i = n, s = Yt.dt(e, Yt.ut(t, r));
let l = r;
...
const r = Bt.st(t.collider, e, s);
if (r) {
const t = Yt.nr(Yt.ct(r.point, e));
l > t && t > 1e-4 && (l = t);
}
}
return l;
}, Nr = (e, t, r, n, a, o = 255, i = .1) => {
if (!r || !n) return;
const s = mt.game, l = t === e, c = s[_t.G].spectating, d = s[_t.M].shotDetected || s[_t.ne].isBindDown(Tt);
let u;
const b = l && !c ? ir() : null;
if (b) {
...
} else if (!l || c || ht.tt && d) if (l && !c && ht.tt) {
const e = s[_t.S][_t.we]({
x: t[_t.de].x,
y: t[_t.de].y
});
u = Math.atan2(e.y - ht.tt.clientY, e.x - ht.tt.clientX) - Math.PI;
} else u = Math.atan2(t[_t.pe].x, t[_t.pe].y) - Math.PI / 2; else u = Math.atan2(s[_t.te].mousePos._y - dt.innerHeight / 2, s[_t.te].mousePos._x - dt.innerWidth / 2);
const p = Yt.it(Math.cos(u), -Math.sin(u)), f = dr(t[_t.de], p, n), h = {
x: 16 * (f.x - e[_t.de].x),
y: 16 * (e[_t.de].y - f.y)
...
for (let r = 0; x > r; r++) {
const n = u - g / 2 + g * (r / (x - 1)), o = Yt.it(Math.cos(n), -Math.sin(n)), i = _r(f, o, m, t.layer), s = Yt.dt(f, Yt.ut(o, i)), l = {
x: 16 * (s.x - e[_t.de].x),
y: 16 * (e[_t.de].y - s.y)
};
...
let jr = Date.now(), Sr = !1, Cr = null;

const Or = () => {
Sr = !1, Cr && (Cr.destroy(), Cr = null);
}, Rr = () => {
var e;
if ((() => {
const e = mt.game;
...
const t = e[_t.$];
return null != t?.[_t.se]?.[_t.ve] && null != t?.[_t.ie]?.[_t.Me];
})()) if (3 === mt.game[_t.$][_t.se][_t.ve]) try {
const t = mt.game, r = t[_t.$], n = r[_t.ie][_t.Me], a = (Date.now() - jr) / 1e3;
if (!(e => "cook" === e.throwableState)(r) || (e = n, !Ar.some(t => e.includes(t)))) return void Or();
if (a > 4 && (Sr = !1), !Sr) return Or(), Cr = new mt.game[_t.G][_t.le].constructor, 
mt.pixi.stage.addChild(Cr.container), Cr.start("Grenade", 0, 4), Sr = !0, void (jr = Date.now());
...
Gt: null,
Pt: !1
}, Pr = e => e.layer, Er = (e, t) => !!(e => 2 === e || 3 === e)(e) || e === t, Tr = [ "metal_wall_", "brick_wall_", "concrete_wall_", "stone_wall_", "container_wall_", "_wall_int_", "bank_wall_", "barn_wall_", "cabin_wall_", "hut_wall_", "house_wall_", "mansion_wall_", "police_wall_", "shack_wall_", "outhouse_wall_", "teahouse_wall_", "warehouse_wall_", "silo_", "bollard_", "sandbags_", "hedgehog", "stone_01", "stone_02", "stone_03", "stone_04", "stone_05", "stone_06", "stone_07", "stone_08", "stone_09", "stone_0", "tree_", "glass_wall_", "locker_", "deposit_box_" ], Ir = [ "bush_", "brush_", "crate_", "barrel_", "refrigerator_", "control_panel_", "chest_", "case_", "oven_", "bed_", "bookshelf_", "couch_", "table_", "drawers_", "window", "toilet_", "pot_", "planter_", "pumpkin_", "potato_", "egg_", "woodpile_", "decal" ], Lr = e => {
if (!1 === e.collidable) return !1;
const t = e.type || "";
if (!0 === e.isWall) return !0;
if (!1 === e.destructible) return !0;
for (const e of Tr) if (t.includes(e)) return !0;
for (const e of Ir) if (t.includes(e)) return !1;
return void 0 !== e.health && e.health > 200;
}, Dr = (e, t, r, n) => {
if (!r || !n) return !0;
const a = mt.game, o = a?.[_t.U]?.[_t.Ae];
if (!o) return !0;
const i = e.layer, s = e[_t.be], l = t[_t.be], c = l.x - s.x, d = l.y - s.y, u = Math.atan2(d, c), b = (r.shotSpread || 0) * (Math.PI / 180) * 1.5, p = Math.hypot(c, d), f = Math.max(Math.min(30, r.shotSpread ? Math.ceil(2 * (r.shotSpread || 0)) : 15), Math.ceil(p / 50)), h = Object.values(o).filter(e => !(!e.collider || e.dead || void 0 !== e.height && .25 > e.height || void 0 !== e.layer && !Gt(e.layer, i))).filter(Lr);
if (0 === h.length) return !0;
const g = new Map;
for (const e of h) g.set(e, new Map);
let m = 0;
for (let e = 0; f > e; e++) {
const t = u - b / 2 + b * (1 === f ? .5 : e / (f - 1)), r = Yt.it(Math.cos(t), Math.sin(t)), n = Yt.dt(s, Yt.ut(r, p));
let a = !1;
for (const e of h) {
let r = g.get(e).get(t);
if (void 0 === r && (r = Bt.st(e.collider, s, n), g.get(e).set(t, r)), r && p - .75 > Yt.nr(Yt.ct(r.point, s))) {
a = !0;
break;
}
}
...
const Br = (e, t, r, n) => Yt.ar(e, t, r, n);

let Gr, Kr = !1;

const Ur = () => {
Gr = xt.Ln.je;
}, qr = () => xt.xt.je && xt.xt.kt, Vr = () => {
...
0 === e.button && (Gr = !1, Kr = !1);
}, Wr = () => {
if (xt.Ln.je) {
if (qr()) {
const e = (() => {
if (qr()) return b() && Fr.Yt;
try {
const e = mt.game;
...
const r = e[_t.Zr];
return !(!r || !r.Jr) && t.some(e => e && e.active && !e[_t.ie][_t.ze] && e.__id !== r.__id);
} catch {
return !1;
}
})(), t = (() => {
...
if (!r) return !1;
const n = r[_t.ve];
return 0 === n || 1 === n || !(2 !== n || !xt.yt.je || !xt.xt.Nt) && 5.5 > (() => {
try {
const e = mt.game;
if (!e || !e.initialized) return 1 / 0;
const t = e[_t.Qr][_t.Ze], r = e[_t.$];
if (!t || !r) return 1 / 0;
let n = 1 / 0;
for (const e of t) {
...
e && t && !Kr ? (dt.dispatchEvent(new MouseEvent("mousedown", {
bubbles: !0,
cancelable: !0,
view: dt,
button: 0
...
}, Xr = [ "container_01", "barn_02", "stone_01", "tree_01", "tree_03", "tree_03cb", "tree_03d", "tree_03f", "tree_03h", "tree_03sp", "tree_03su", "tree_03sv", "tree_03w", "stone_04", "stone_05", "bunker_storm_01" ], Zr = {
...
var e, t;
if (n() && xt.Gn.je) try {
const r = mt.game[_t.$][_t.se], n = r[_t.ve], a = r[_t._e], o = a[n], i = en[n];
if (xt.xt.Nt && xt.yt.je && 150 > (() => {
try {
const e = mt.game, t = e[_t.Qr][_t.Ze], r = e[_t.$], n = e[_t.te].mousePos;
let a = 1 / 0;
for (const o of t) {
...
})() && 2 !== n) return void tn(It);
if (null !== Fr.Gt && 2 !== n) return void tn(It);
if (o.ammo === i.ta) return;
const s = 0 === n ? 1 : 0, l = a[s];
rn(o.type) && o.type === i.ra && (i.ta > o.ammo || 0 === i.ta && o.ammo > i.ta && (mt.game[_t.M].shotDetected || mt.game[_t.ne].isBindDown(Tt))) && (i.na = Date.now(), 
rn(l.type) && l.ammo && !xt.Gn.qn ? an(s) : "" !== l.type ? (t = n, an(s), an(t)) : (e = n, 
tn(It), an(e))), i.ta = o.ammo, i.ra = o.type;
} catch {}
}, sn = 2 * Math.PI;

let ln = 0, cn = 0, dn = Math.random() * sn, un = !1, bn = 0;

const pn = [ 0, -Math.PI / 2, Math.PI, Math.PI / 2 ], fn = [ 0, 2 * Math.PI / 3, 4 * Math.PI / 3 ], hn = [ 0, Math.PI ], gn = () => {
if (!un && xt.Kt.je) return xt.Kt.qt ? (cn += (2 * Math.random() - 1) * (xt.Kt.Kn / 50) * .15, 
cn *= .92, void (ln += cn)) : void (xt.Kt.Vt ? Math.random() < xt.Kt.Kn / 100 * 2 && (bn = (bn + 1) % 2) : xt.Kt.Ut ? Math.random() < xt.Kt.Kn / 100 * 2 && (bn = (bn + 1) % 3) : xt.Kt.Ht ? Math.random() < xt.Kt.Kn / 100 * 2 && (bn = (bn + 1) % 4) : Math.random() < xt.Kt.Kn / 100 * 2 && (dn = Math.random() * sn));
}, mn = (e, t) => ({
get() {
return t.call(this);
},
...
}), xn = e => un && !ht.tt || e, yn = "surt-blur-start-overlay", wn = {
sv98: 1,
mosin: 1,
awc: 1,
scout: 1,
...
for (const [e, r] of Object.entries(wn)) if (t.includes(e) || e.includes(t)) return r;
try {
const t = Lt[e];
...
if (!n() || !xt.Vn?.je) return kn.aa = !1, void (kn.oa = null);
try {
const e = mt.game[_t.$][_t.se], t = e[_t.ve], r = e[_t._e];
if (0 !== t && 1 !== t) return void (kn.aa = !1);
const n = r[0], a = r[1];
if (n.type === kn.la && a.type === kn.ca || (kn.la = n.type, kn.ca = a.type, kn.oa = null, 
kn.ia = 0), nn(n.type) || nn(a.type)) return void (kn.aa = !1);
if (!Mn(n.type) && !Mn(a.type)) return void (kn.aa = !1);
kn.aa = !0, kn.oa || (kn.oa = ((e, t) => {
const r = vn(e), n = vn(t);
if (.3 === r && .9 === n) return [ {
weapon: 0,
wait: .3
...
})(n.type, a.type), kn.ia = 0, kn.sa = Date.now());
const o = Date.now(), i = kn.oa, s = i[kn.ia];
s.wait > (o - kn.sa) / 1e3 || (t !== s.weapon && gt.jt.push(zn[s.weapon]), kn.ia = (kn.ia + 1) % i.length, 
kn.sa = o);
} catch (e) {
kn.aa = !1;
}
...
je = Array.isArray, fe = (Ne = []).slice, he = {
Qt(e, t, r, n) {
for (var a, o, i; t = t.Zt; ) if ((a = t.en) && !a.Zt) try {
if ((o = a.constructor) && null != o.da && (a.On(o.da(e)), i = a.sn), null != a.ua && (a.ua(e, n || {}), 
i = a.sn), i) return a.bn = a;
} catch (t) {
e = t;
}
throw e;
}
}, ge = 0, k.prototype.On = function(e, t) {
var r;
r = null != this.fn && this.fn != this.state ? this.fn : this.fn = g({}, this.state), 
"function" == typeof e && (e = e(g({}, r), this.$t)), e && g(r, e), null != e && this.tn && (t && this._sb.push(t), 
z(this));
}, k.prototype.ba = function(e) {
this.tn && (this.Qt = !0, e && this.pn.push(e), z(this));
}, k.prototype.render = w, me = [], ye = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, 
we = (e, t) => e.tn.Jt - t.tn.Jt, _.ln = 0, ke = /(PointerCapture)$|Capture$/i, 
ve = 0, Me = R(!1), ze = R(!0), Fe = 0, Pe = [], Te = (Ee = he).Jt, Ie = Ee.ln, 
Le = Ee.Mn, De = Ee.en, Ye = Ee.unmount, Be = Ee.Zt, Ee.Jt = e => {
Ce = null, Te && Te(e);
}, Ee.Zt = (e, t) => {
e && t.Xt && t.Xt.zn && (e.zn = t.Xt.zn), Be && Be(e, t);
}, Ee.ln = e => {
Ie && Ie(e), Se = 0;
var t = (Ce = e.en).Cn;
t && (Oe === Ce ? (t.pn = [], Ce.pn = [], t.Zt.forEach(e => {
e.Nn && (e.Zt = e.Nn), e.u = e.Nn = void 0;
})) : (t.pn.forEach(Z), t.pn.forEach(J), t.pn = [], Se = 0)), Oe = Ce;
}, Ee.Mn = e => {
Le && Le(e);
var t = e.en;
t && t.Cn && (t.Cn.pn.length && (1 !== Pe.push(t) && Re === Ee.requestAnimationFrame || ((Re = Ee.requestAnimationFrame) || X)(W)), 
t.Cn.Zt.forEach(e => {
e.u && (e.Cn = e.u), e.u = void 0;
})), Oe = Ce = null;
}, Ee.en = (e, t) => {
t.some(e => {
try {
e.pn.forEach(Z), e.pn = e.pn.filter(e => !e.Zt || J(e));
} catch (r) {
t.some(e => {
e.pn && (e.pn = []);
}), t = [], Ee.Qt(r, e.tn);
...
Ye && Ye(e);
var t, r = e.en;
r && r.Cn && (r.Cn.Zt.forEach(e => {
try {
Z(e);
} catch (e) {
t = e;
}
}), r.Cn = void 0, t && Ee.Qt(t, r.tn));
}, Ge = "function" == typeof requestAnimationFrame, (re.prototype = new k).pa = !0, 
re.prototype.yn = function(e, t) {
return te(this.$t, e) || te(this.state, t);
}, Ke = he.Jt, he.Jt = e => {
e.type && e.type.jn && e.ref && (e.$t.ref = e.ref, e.ref = null), Ke && Ke(e);
}, Ue = he.Qt, he.Qt = (e, t, r, n) => {
if (e.then) for (var a, o = t; o = o.Zt; ) if ((a = o.en) && a.en) return null == t.Qt && (t.Qt = r.Qt, 
t.Xt = r.Xt), a.en(e, t);
Ue(e, t, r, n);
}, qe = he.unmount, he.unmount = e => {
var t = e.en;
t && t.fa && t.fa(), t && 32 & e.rn && (e.type = null), qe && qe(e);
}, (oe.prototype = new k).en = function(e, t) {
var r, n, a, o, i = t.en, s = this;
null == s.o && (s.o = []), s.o.push(i), r = ie(s.tn), n = !1, a = () => {
n || (n = !0, i.fa = null, r ? r(o) : o());
}, i.fa = a, o = () => {
var e, t;
if (! --s.rn) for (s.state.Pn && (s.tn.Xt[0] = ae(e = s.state.Pn, e.en.dn, e.en.ha)), 
s.On({
Pn: s.Jt = null
}); t = s.o.pop(); ) t.ba();
}, s.rn++ || 32 & t.rn || s.On({
...
}, oe.prototype.An = function() {
this.o = [];
}, oe.prototype.render = function(e, t) {
var r, n, a;
return this.Jt && (this.tn.Xt && (r = document.createElement("div"), this.tn.Xt[0] = ne(this.Jt, r, (n = this.tn.Xt[0].en).ha = n.dn)), 
this.Jt = null), (a = t.Pn && x(w, null, e.fallback)) && (a.rn &= -33), [ x(w, null, t.Pn ? null : e.children), a ];
}, Ve = (e, t, r) => {
if (++r[1] === r[0] && e.l.delete(t), e.$t.ga && ("t" !== e.$t.ga[0] || !e.l.size)) for (r = e.i; r; ) {
for (;r.length > 3; ) r.pop()();
if (r[0] > r[1]) break;
e.i = r = r[2];
}
}, (se.prototype = new k).Pn = function(e) {
var t = this, r = ie(t.tn), n = t.l.get(e);
return n[0]++, a => {
var o = () => {
t.$t.ga ? (n.push(a), Ve(t, e, n)) : a();
};
r ? r(o) : o();
};
}, se.prototype.render = function(e) {
var t, r;
for (this.i = null, this.l = new Map, t = j(e.children), e.ga && "b" === e.ga[0] && t.reverse(), 
r = t.length; r--; ) this.l.set(t[r], this.i = [ 1, 0, this.i ]);
return e.children;
}, se.prototype.kn = se.prototype.mn = function() {
var e = this;
this.l.forEach((t, r) => {
Ve(e, r, t);
});
}, He = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103, 
...
We = /^on(Ani|Tra|Tou|BeforeInp|Compo)/, Xe = /[A-Z0-9]/g, Ze = "undefined" != typeof document, 
Je = e => ("undefined" != typeof Symbol && "symbol" == typeof Symbol() ? /fil|che|rad/ : /fil|che|ra/).test(e), 
k.prototype.ma = {}, [ "componentWillMount", "componentWillReceiveProps", "componentWillUpdate" ].forEach(function(e) {
...
}), Qe = he.event, he.event = e => (Qe && (e = Qe(e)), e.persist = le, e.xa = ce, 
e.ya = de, e.wa = e), et = {
enumerable: !1,
configurable: !0,
get() {
...
"defaultValue" === t && "value" in a && null == a.value ? t = "value" : "download" === t && !0 === r ? r = "" : "translate" === n && "no" === r ? r = !1 : "o" === n[0] && "n" === n[1] ? "ondoubleclick" === n ? t = "ondblclick" : "onchange" !== n || "input" !== o && "textarea" !== o || Je(a.type) ? "onfocus" === n ? t = "onfocusin" : "onblur" === n ? t = "onfocusout" : We.test(t) && (t = n) : n = t = "oninput" : s && $e.test(t) ? t = t.replace(Xe, "-$&").toLowerCase() : null === r && (r = void 0), 
...
const An = e => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), jn = e => {
const t = (e => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, r) => r ? r.toUpperCase() : t.toLowerCase()))(e);
return t.charAt(0).toUpperCase() + t.slice(1);
}, Sn = (...e) => e.filter((e, t, r) => !!e && "" !== e.trim() && r.indexOf(e) === t).join(" ").trim();
...
const Cn = ({color: e = "currentColor", size: t = 24, strokeWidth: r = 2, absoluteStrokeWidth: n, children: a, iconNode: o, class: i = "", ...s}) => x("svg", {
...it,
width: t + "",
height: t,
stroke: e,
...
class: [ "lucide", i ].join(" "),
...s
}, [ ...o.map(([e, t]) => x(e, t)), ...j(a) ]), On = (e, t) => {
const r = ({class: r = "", children: n, ...a}) => x(Cn, {
...a,
iconNode: t,
class: Sn("lucide-" + An(jn(e)), "lucide-" + An(e), r)
}, n);
return r.displayName = jn(e), r;
}, Rn = On("arrow-left-right", [ [ "path", {
d: "M8 3 4 7l4 4",
key: "9rb6wj"
} ], [ "path", {
d: "M4 7h16",
...
d: "M20 6 9 17l-5-5",
key: "1gmf2c"
} ] ]), En = On("circle-question-mark", [ [ "circle", {
cx: "12",
cy: "12",
r: "10",
key: "1mglay"
...
Da: Ln,
La: Un
}, Xn = ({onMouseDown: e, version: t, Ea: r}) => be("div", {
className: "titlebar",
onMouseDown(t) {
e(t);
},
...
}), Zn = ({activeTab: e, onTabChange: t}) => be("div", {
className: "sidebar",
children: be("div", {
...
}), Jn = ({id: e, label: t, checked: r, onChange: n, style: a = {}, warning: o = !1}) => be("div", {
...
const [s, l] = U(!1), c = V(null), d = (r - n) / (a - n) * 100, u = {
...
}, ta = ({keybind: e, mode: t = "single", style: r = {}, onClick: n, editable: a = !1}) => {
const [o, i] = U(!1);
...
const t = e => {
e.preventDefault(), e.stopPropagation(), n(e.code), i(!1), Reflect.apply(Ot, dt, [ "keydown", t, !0 ]);
};
Reflect.apply(Ct, dt, [ "keydown", t, !0 ]);
},
children: [ s, a && !o && be(Wn.Ra, {
className: "keybind-pen-icon"
}) ]
});
}, ra = ({icon: e, label: t, keybind: r, keybindMode: n, keybindEditable: a, onKeybindChange: o, enabled: i, onEnabledChange: s, warning: l = !1}) => be("div", {
...
checked: i,
onChange(e) {
s(e), ut.dispatchEvent(new CustomEvent("featureToggled", {
detail: {
featureName: t,
enabled: e
}
...
keybind: e.Hn.$n,
keybindEditable: !0,
onKeybindChange: e => t(t => t.Hn.$n = e),
enabled: e.xt.je,
...
label: "Aimbot Dot",
checked: e.xt.Dn,
onChange: e => t(t => t.xt.Dn = e)
}), be(Jn, {
id: "aimbot-hud",
label: "TargetHUD",
checked: e.Un.je,
onChange: e => t(t => t.Un.je = e)
}), be(Qn, {
id: "aimbot-wallcheck",
label: "Wallcheck",
checked: e.xt.Rt,
...
label: "Blatant",
checked: e.xt.kt,
onChange: e => t(t => t.xt.kt = e),
warning: !0
}), be(ta, {
keybind: e.Hn.Xn,
editable: !0,
onClick: e => t(t => t.Hn.Xn = e)
}) ]
}) ]
}), be(ra, {
icon: Wn.va,
...
label: "Auto Switch",
enabled: e.Gn.je,
onEnabledChange: e => t(t => t.Gn.je = e)
}), be("div", {
className: "group " + (e.Gn.je ? "" : "hidden"),
children: be(Jn, {
id: "useonegun",
label: "Use One Gun",
checked: e.Gn.qn,
onChange: e => t(t => t.Gn.qn = e)
})
}), be(ra, {
icon: Wn.Ma,
label: "Semi Auto",
enabled: e.Ln.je,
onEnabledChange: e => t(t => t.Ln.je = e)
}), be(ra, {
icon: Wn.za,
label: "Desync",
enabled: e.Vn.je,
...
keybind: e.Hn.Zn,
keybindEditable: !0,
onKeybindChange: e => t(t => t.Hn.Zn = e),
enabled: e.Kt.je,
...
enabled: e.En.je,
onEnabledChange: e => t(t => t.En.je = e)
}), be("div", {
className: "group " + (e.En.je ? "" : "hidden"),
children: be(Jn, {
id: "smaller-trees",
label: "Smaller Trees",
checked: e.En.In,
onChange: e => t(t => t.En.In = e)
})
}), be(ra, {
icon: Wn.ja,
label: "Auto Loot",
enabled: e.Yn.je,
onEnabledChange: e => t(t => t.Yn.je = e)
}) ]
}), ia = ({Ia: e}) => be("div", {
...
}), sa = ({Ia: e, Ba: t, Ea: r, version: n}) => {
const [a, o] = U("main"), [i, s] = U({
x: 50,
y: 50
}), [l, c] = U(!1), [d, u] = U({
x: 0,
...
const l = 0, c = dt.innerHeight - n.height;
o = Math.max(-(t.offsetWidth - a), Math.min(dt.innerWidth - a, o)), i = Math.max(l, Math.min(c, i)), 
s({
x: o,
y: i
});
...
return l && (Reflect.apply(Ct, ut, [ "mousemove", e ]), Reflect.apply(Ct, ut, [ "mouseup", t ])), 
() => {
Reflect.apply(Ot, ut, [ "mousemove", e ]), Reflect.apply(Ot, ut, [ "mouseup", t ]);
};
}, [ l, d ]), q(() => {
const e = () => {
const e = b.current;
...
return Reflect.apply(Ct, dt, [ "resize", e ]), () => {
Reflect.apply(Ot, dt, [ "resize", e ]);
};
}, []);
const p = e => {
e.stopPropagation();
...
let ca = null, da = null, ua = () => {}, ba = "", pa = !1;

const fa = () => {
ca && pa && ca.render(be(sa, {
Ia: xt,
Ba: pe,
Ea: () => ua(!1),
version: ba
...
const n = !e(xt);
t(xt, n), fa(), ut.dispatchEvent(new CustomEvent("featureToggled", {
detail: {
featureName: r,
enabled: n
}
...
const xa = () => {
ma || (Dt.tr = mt.pixi.stage.constructor, Dt.er = mt.pixi.stage.children.find(e => e.lineStyle)?.constructor, 
or(), mt.pixi._ticker.add(c), mt.pixi._ticker.add(Rr), (() => {
const e = () => {
(e => !!e && (sr.Xr || (sr.Xr = dt.document.createElement("div"), sr.Xr.classList.add("aimbot-dot"), 
e.appendChild(sr.Xr)), sr.Le = !0, !0))(yt) ? Yr || (mt.pixi._ticker.add(u), Yr = !0) : requestAnimationFrame(e);
};
e();
})(), mt.pixi._ticker.add(on), (() => {
if (Nn) return;
Nn = !0;
const e = setInterval(() => {
mt?.pixi?._ticker && (clearInterval(e), mt.pixi._ticker.add(_n));
}, 100);
})(), function() {
mt.pixi._ticker.add(p), mt.pixi._ticker.add(gn);
let e = 0, t = 0, n = !1;
...
At.defineProperty(a, "y", mn("y", function() {
return xn(n) ? this._y : un && ht.tt && xt.xt.je ? ht.tt.clientY : !un && xt.Kt.je ? (t = h("y"), 
t) : this._y;
})), At.defineProperty(a, "x", mn("x", function() {
return xn(n) ? this._x : un && ht.tt && xt.xt.je ? ht.tt.clientX : !un && xt.Kt.je ? (e = h("x"), 
e) : this._x;
})), jt.apply(Ct, dt, [ "mousedown", e => {
0 === e.button && (un = !0);
} ]), jt.apply(Ct, dt, [ "mouseup", e => {
0 === e.button && (un = !1);
} ]);
}(), ma = !0), Nt || (mt.pixi._ticker.add(t), Nt = !0);
}, ya = {
Ya: null,
Ga: null,
qa: 0
...
let n = e[r];
Array.isArray(n) ? t.k++ : "object" == typeof n && null !== n ? t.m++ : "function" == typeof n ? t.h++ : t.p++, 
t.v++;
...
try {
n[e].hasOwnProperty("deadBodyPool") ? a.I = e : n[e].hasOwnProperty("airdropPool") && (a.D = e);
} catch {}
try {
...
try {
null != a.M && null == a.ve && n[a.M].getAimMovement.call({}, {
[a.se]: new Proxy({}, {
get(e, t) {
a.ve = t;
}
...
try {
null != a.L && null == a.Se && (a.Se = Object.getOwnPropertyNames(e.game[a.L]).find(t => e.game[a.L][t] instanceof dt.Array));
} catch {}
try {
...
apply(e, t, r) {
const [n, a] = r;
return 1 === n && (a.isMobile = xt.Yn.je), 3 === n && (e => {
for (const t of gt.jt) e.addInput(t);
gt.jt.length = 0;
})(a), a.inputs ? ((e => {
if (!Gr) {
if (!xt.xt.je || !xt.xt.kt || !b()) return;
try {
const e = mt.game, t = e?.[_t.Zr];
if (!t) return;
...
const a = n[r];
if (!a) return !1;
const o = 0 === r ? "primary_" : "secondary_", i = ya[o];
return null !== i && i > a.ammo || (ya[o] = a.ammo, ya.qa = performance.now(), !1);
} catch {
return !1;
}
})()) return;
...
})(a), o = a, ht.Fn && (o.touchMoveActive = !0, o.touchMoveLen = !0, o.touchMoveDir.x = ht.Fn.x, 
o.touchMoveDir.y = ht.Fn.y), (e => {
if (!e) return;
const t = Ht.Ee, r = !!e.shootStart || !!e.shootHold || Array.isArray(e.inputs) && e.inputs.includes(Tt);
r && !wa.Ha && xt.xt.je && (wa.Wa = 3), wa.Ha = r, r || (wa.Wa = 0);
const n = wa.Wa > 0;
if (n && wa.Wa--, !(Ht.Hr && "idle" !== t || n)) return wa.Ka && (e.shootStart = !0, 
wa.Va && (e.shootHold = !0, Array.isArray(e.inputs) && wa.Ua && !e.inputs.includes(Tt) && e.inputs.push(Tt))), 
wa.Ka = !1, wa.Va = !1, wa.Ua = !1, void (wa.Wa = 0);
let a = !1;
...
(o || i) && (e.shootStart = !1, e.shootHold = !1, wa.Ka = wa.Ka || o || i, wa.Va = wa.Va || i, 
wa.Ua = wa.Ua || a);
})(a), gt.nt = a.toMouseLen, Reflect.apply(e, t, r)) : Reflect.apply(e, t, r);
var o;
}
});
})();
...
kt = !0, pa = !0, fa(), da && pa && !0 !== xt.Jn.Qn && da.render(be(DiscordNotification, {
Ia: xt,
Ba: pe
}));
}
...
"loading" === ut.readyState ? Reflect.apply(Ct, ut, [ "DOMContentLoaded", t ]) : t();
})(), Ur(), Reflect.apply(Ct, dt, [ "mousedown", Hr ]), Reflect.apply(Ct, dt, [ "mouseup", $r ]), 
setInterval(Wr, 16), r(dt.Array.prototype, "sort", {
apply(e, t, r) {
try {
xt.En.je && t.some(e => null != e?.obj?.ori) && (e => {
try {
e.forEach(e => {
if (!e || !e.obj || !e.shapes) return;
const t = e.obj.type;
if (!Xr.includes(t)) return;
const r = Zr[t], n = Jr[t] || 1;
e.shapes.forEach(e => {
e.color = r, e.scale = n;
}), e.zIdx = 999;
});
...
e.appendChild(i), s = ut.createElement("span"), s.id = "surt-adr-display", s.classList.add("surt-stat", "surt-adr"), 
e.appendChild(s);
let t = null;
l = setInterval(() => {
try {
...
const n = ut.getElementById("ui-boost-counter-0")?.querySelector(".ui-bar-inner"), a = ut.getElementById("ui-boost-counter-1")?.querySelector(".ui-bar-inner"), o = ut.getElementById("ui-boost-counter-2")?.querySelector(".ui-bar-inner"), l = ut.getElementById("ui-boost-counter-3")?.querySelector(".ui-bar-inner");
...
b(), setInterval(b, 1e3);
})(), t = ka, r(dt.Function.prototype, "call", {
apply(e, r, n) {
try {
